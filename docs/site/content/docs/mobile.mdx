...
<Callout title="Beta">
  ...
  Store](https://apps.apple.com/us/app/manta-ide/id6766130217), join the [TestFlight preview
...
<Callout title="Next steps">
  ...
  alerts reach the right device. For headless machines, use [Remote Manta
