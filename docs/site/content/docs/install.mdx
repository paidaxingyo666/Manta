...
Older versions are always available on the [GitHub Releases page](https://github.com/stablyai/orca/releases). Manta will not force-downgrade your worktree data if you go back.
</Callout>
