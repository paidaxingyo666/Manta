...
The remaining child-first case is inherently ambiguous to Manta: task children and
...
session reaches Manta's callback before any child. An earlier user extension can
