...
[iOS App Store](https://apps.apple.com/us/app/manta-ide/id6766130217) · [Android APK](https://github.com/stablyai/orca/releases/download/mobile-android-v0.0.47/app-release.apk) · [文档 →](https://www.manta.sh.cn/docs/mobile)
...
- **微信:** 扫码加入 Manta 社区微信第 8 群。第 8 群可能已满，如遇这种情况请扫描第 9 群二维码。

  <img src="../assets/wechat-qr-group8.jpg" alt="Manta 社区微信第 8 群二维码" width="160" />&nbsp;&nbsp;<img src="../assets/wechat-qr-group9.jpg" alt="Manta 社区微信第 9 群二维码" width="160" />
