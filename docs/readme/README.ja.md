...
<p align="center">
  <a href="https://github.com/paidaxingyo666/Manta"><img src="https://img.shields.io/github/stars/paidaxingyo666/Manta?style=flat&amp;label=%E2%98%85&amp;color=08C" alt="GitHub スター数" /></a>
...
- **[manta.sh.cn からダウンロード](https://manta.sh.cn/download)**
- またはビルドを直接入手: [macOS Apple Silicon](https://github.com/paidaxingyo666/Manta/releases/latest/download/manta-macos-arm64.dmg) · [macOS Intel](https://github.com/paidaxingyo666/Manta/releases/latest/download/manta-macos-x64.dmg) · [Windows (.exe)](https://github.com/paidaxingyo666/Manta/releases/latest/download/manta-windows-setup.exe) · [Linux AppImage](https://github.com/paidaxingyo666/Manta/releases/latest/download/manta-linux.AppImage) · [すべてのビルド](https://github.com/paidaxingyo666/Manta/releases/latest)
...
- **Android:** [APK をダウンロード](https://github.com/paidaxingyo666/Manta/releases/download/mobile-android-v0.0.43/app-release.apk)
...
- **Twitter / X:** アップデートやお知らせは **[@orca_build](https://x.com/orca_build) (upstream Orca account)** をフォローしてください。
- **フィードバックとアイデア:** 私たちは高速にリリースしています。足りない機能がありますか？[機能リクエストを送信](https://github.com/paidaxingyo666/Manta/issues)してください。
