...
const paths = [
  'src/main/runtime/manta-runtime-sync-window-graph.ts',
  'src/main/runtime/manta-runtime-mark-pty-liveness-unverifiable.ts',
  'src/main/runtime/manta-runtime-on-pty-exit.ts'
]
