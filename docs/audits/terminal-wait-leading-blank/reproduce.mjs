...
if (process.env.MANTA_BACKGROUND_LAUNCH !== '1') {
  throw new Error('Run with MANTA_BACKGROUND_LAUNCH=1.')
}
...
const supportingSources = [
  ...
  'src/main/runtime/manta-runtime-terminal-projection.ts',
...
try {
  ...
  const entry = `
    ...
    import { projectTerminalVisibleLines, projectTerminalTailLines } from './src/main/runtime/manta-runtime-terminal-projection';
