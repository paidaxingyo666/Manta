...
```sh
MANTA_BACKGROUND_LAUNCH=1 node --expose-gc docs/audits/transcript-record-retention/reproduce.mjs
```
...
changed-code quality passed. Tests used `MANTA_BACKGROUND_LAUNCH=1`.
