...
// so the patched bytes differ. Recompute after any upstream change to the patch —
// patch a fixture copy, catch the assertion, and hash the file it already wrote.
const PATCHED_SOURCE_SHA256 = 'e0cd17576d81e2e583ec5c40562a1dc525639073267ce2048e16d6d26fe19be0'
...
function writeSourceAtomically(sourcePath, contents) {
  const temporaryPath = `${sourcePath}.manta-patch-${process.pid}`
