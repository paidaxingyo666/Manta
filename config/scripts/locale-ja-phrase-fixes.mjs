...
// Two-word commands (`git commit`, `manta terminal`) must keep their second word in Latin.
const COMMAND_HEAD = '(?<!\\b(?:git|gh|glab|manta|npm|pnpm|npx|yarn|docker|kubectl) )'
...
export const JA_PHRASE_FIXES = [
  ...
  { pattern: /シャチ:\/\//g, replacement: 'manta://', whenEnIncludes: 'manta://' },
  ...
  { pattern: /崩壊させる/g, replacement: '折りたたむ', whenEnIncludes: 'Collapse Manta' },
  ...
  { pattern: /再起動します/g, replacement: '再起動', whenEnIncludes: 'Restart Manta' },
  ...
  // Manta's host covers SSH hosts and this computer; skipped where the English also says server.
  {
