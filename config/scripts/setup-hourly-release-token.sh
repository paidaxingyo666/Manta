...
# paidaxingyo666/manta-hourly. GITHUB_TOKEN cannot be used: it is scoped to the repo
...
# Widening it to cover paidaxingyo666/manta-adhoc / manta-daily is
...
MAIN_REPO="stablyai/manta"
HOURLY_REPO="paidaxingyo666/manta-hourly"
