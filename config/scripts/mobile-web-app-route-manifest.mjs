...
function routeContext(id) {
  if (!Object.prototype.hasOwnProperty.call(modules, id)) {
    throw new Error('[manta-mobile-web-app] no route module for ' + id)
  }
  return modules[id]
}
...
routeContext.resolve = (id) => {
  if (!Object.prototype.hasOwnProperty.call(modules, id)) {
    throw new Error('[manta-mobile-web-app] cannot resolve route ' + id)
  }
  return id
}
routeContext.id = 'manta-mobile-web-app-routes'`
