...
// Asserts that the telemetry compile-time constants — `MANTA_BUILD_IDENTITY`
// and `MANTA_POSTHOG_WRITE_KEY` — were substituted into the shipped binary.
...
function findAsar(rootDir) {
  ...
  // (`dist/mac/Manta.app/Contents/Resources/app.asar` for x64,
  // `dist/mac-arm64/Manta.app/Contents/Resources/app.asar` for arm64) because
...
// identifiers `MANTA_BUILD_IDENTITY` and `MANTA_POSTHOG_WRITE_KEY` with their
