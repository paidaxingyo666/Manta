...
describe('live-remote-bulk-open-freeze-metrics', () => {
  ...
  it('builds worktree selectors from id/path', () => {
    expect(
      worktreeSelector({ id: 'repo::C:/Users/neil/manta/manta', path: 'C:/Users/neil/manta/manta' })
    ).toBe('id:repo::C:/Users/neil/manta/manta')
  ...
  it('rejects invalid numeric environment values', () => {
    process.env.MANTA_FREEZE_TEST_NUMBER = 'not-a-number'
    expect(() => readFreezeNumberEnv('MANTA_FREEZE_TEST_NUMBER', 5)).toThrow(
      'Invalid MANTA_FREEZE_TEST_NUMBER'
    )
    delete process.env.MANTA_FREEZE_TEST_NUMBER
    expect(readFreezeNumberEnv('MANTA_FREEZE_TEST_NUMBER', 5)).toBe(5)
  })
