...
describe('computer-use e2e workflow', () => {
  ...
  it('guards e2e source against fragile waits and Windows Calculator drift', () => {
    ...
    expect(cliDriver).toContain('MANTA_DEV_USER_DATA_PATH')
    expect(cliDriver).toContain('manta-computer-runtime-')
    expect(cliDriver).toContain('retryMissingRuntimeMetadata')
    expect(cliDriver).toContain('Could not read Manta runtime metadata')
