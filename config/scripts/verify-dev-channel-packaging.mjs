...
// ignores MANTA_WIN_*, which would resolve `publish.repo` to the *main* repo and
...
const CHANNEL_VERSION_ENV = {
  hourly: 'MANTA_HOURLY_BUILD_VERSION',
  daily: 'MANTA_DAILY_BUILD_VERSION',
  adhoc: 'MANTA_ADHOC_BUILD_VERSION'
}
