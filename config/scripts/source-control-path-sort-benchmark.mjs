...
const ITERATIONS = Number(process.env.MANTA_SC_SORT_BENCH_ITERATIONS ?? '25')
const WARMUP = Number(process.env.MANTA_SC_SORT_BENCH_WARMUP ?? '5')

for (const [name, value] of [
  ['MANTA_SC_SORT_BENCH_ITERATIONS', ITERATIONS],
  ['MANTA_SC_SORT_BENCH_WARMUP', WARMUP]
]) {
