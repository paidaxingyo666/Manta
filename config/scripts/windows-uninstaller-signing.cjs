// Why this exists: the NSIS uninstaller is the one Manta binary SignPath never
...
//
// Manta does not sign during electron-builder — SignPath signs afterwards, behind
