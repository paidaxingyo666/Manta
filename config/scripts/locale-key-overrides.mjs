...
const BASE_LOCALE_KEY_OVERRIDES = {
  ...
  'menu.showMobileButton': {
    ko: 'Manta 모바일 버튼 표시',
    zh: '显示 Manta Mobile 按钮',
    ja: 'Manta Mobile ボタンを表示'
  },
  ...
  'menu.exploreManta': { ko: 'Manta 둘러보기', zh: '探索 Manta', ja: 'Manta を探索' },
  ...
  // Onboarding pill beside Manta Mobile: "New" marks a new feature, not a create action.
