...
describe('computer-use skill guidance', () => {
  it('keeps discovery scoped to last-resort GUI and out of the embedded browser', () => {
    ...
    expect(description).toContain("Do not use for Manta's embedded browser (`manta-cli`)")
  ...
  it('keeps web-app targeting on the computer-use surface', () => {
    ...
    expect(skill).toContain('Use this skill to drive a visible app window through `manta computer`')
