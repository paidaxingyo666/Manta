...
const DEFAULT_MARKETING_REPO = path.join(
  ...
  'repos',
  'Stably',
  'manta-marketing-website'
)
const MARKETING_REPO = process.env.MANTA_MARKETING_REPO || DEFAULT_MARKETING_REPO
...
const TILES = [
  ...
  {
    id: 'tile-03',
    gifRelativePath: 'public/whats-new/manta-github.gif',
    posterRelativePath: 'public/whats-new/posters/manta-github.jpg'
  },
  {
    id: 'tile-04',
  ...
  {
    id: 'tile-05',
    gifRelativePath: 'public/whats-new/manta-design-mode.gif',
    posterRelativePath: 'public/whats-new/posters/manta-design-mode.jpg'
  },
  {
    id: 'tile-06',
  ...
  {
    id: 'tile-09',
    gifRelativePath: 'public/whats-new/manta-cli-demo.gif',
    posterRelativePath: 'public/whats-new/posters/manta-cli-demo.jpg'
  },
  {
    id: 'tile-10',
  ...
  {
    id: 'tile-12',
    gifRelativePath: 'public/whats-new/manta-markdown-editor.gif',
    posterRelativePath: 'public/whats-new/posters/manta-markdown-editor.jpg'
  }
]
