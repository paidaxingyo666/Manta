...
const knobByFlag = {
  ...
  '--panes': 'MANTA_TYPING_BENCH_LOAD_PANES',
  '--rate-kbps': 'MANTA_TYPING_BENCH_RATE_KBPS',
  '--keys': 'MANTA_TYPING_BENCH_KEYS',
  '--cadence-ms': 'MANTA_TYPING_BENCH_KEY_CADENCE_MS',
  '--cpu-workers': 'MANTA_TYPING_BENCH_CPU_WORKERS',
  ...
  '--label': 'MANTA_TYPING_BENCH_LABEL'
}

const env = { ...process.env, MANTA_BACKGROUND_LAUNCH: '1', MANTA_TYPING_BENCH: '1' }
