...
- The child's allowlisted environment includes `MANTA_BACKGROUND_LAUNCH=1`.
...
This is not a packaged/full Manta desktop launch. The host and scanner are bundled
