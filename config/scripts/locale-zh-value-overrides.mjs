...
export const ZH_VALUE_OVERRIDES = {
  ...
  'Manta IDE': 'Manta IDE',
  'Manta first': 'Manta 优先',
  'Manta Mobile': 'Manta Mobile',
  'Manta logo': 'Manta 标志',
  'Enjoying Manta?': '喜欢 Manta 吗？',
  'Get to know Manta': '了解 Manta',
  'Expand Manta': '展开 Manta',
  'Support Manta': '支持 Manta',
  'Restarting Manta…': '正在重启 Manta…',
  'Show Manta Mobile Button': '显示 Manta Mobile 按钮',
  ...
  "Give agents direct access to Manta's browser so they can test pages, capture screenshots, and act on what they see.":
    '让代理直接访问 Manta 的浏览器，以便测试页面、捕获屏幕截图并根据所见内容执行操作。',
  ...
  'from Manta. It is still on your disk.': '来自 Manta。它仍保留在您的磁盘上。',
