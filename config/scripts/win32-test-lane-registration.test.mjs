...
const MANUAL_OPT_IN = [
  ...
  // `enabled = platform === 'win32' && MANTA_REAL_WSL_RUNNER_TEST === '1'`; mutates a real distro's ~/.profile.
 ...
 *
 * One hop is enough for every real case: `distro = process.env.MANTA_TEST_WSL_DISTRO`
