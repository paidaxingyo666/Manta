...
Engage Manta's Linear CLI whenever you work a Linear-linked task: read linked ticket context,
...
`MANTA skills get linear-tickets`. Beyond these commands, ask the user rather than guessing a
