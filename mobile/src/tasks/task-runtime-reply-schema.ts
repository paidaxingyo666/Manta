 ...
 * optional at every read (:283 spells `uiState?.trustedMantaHooks ?? {}`, :284
 ...
 * opaque forwards: `trustedMantaHooks` goes straight into state, and `taskResumeState` is the
  ...
  .looseObject({
    ui: salvagedOptional(
      ...
      z.looseObject({
        ...
        trustedMantaHooks: z.unknown().optional()
      })
    )
  })
  .nullish()
