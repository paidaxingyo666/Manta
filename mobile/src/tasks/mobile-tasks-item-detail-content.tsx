    ...
    <>
      <View style={styles.detailMetaGrid}>
        <View style={styles.detailMetaItem}>
          <Text style={styles.detailMetaLabel}>{translate('m.tasks.a36f9052f5', 'Type')}</Text>
          <Text style={styles.detailMetaValue}>{taskKindLabel(actionItem)}</Text>
        </View>
        <View style={styles.detailMetaItem}>
          <Text style={styles.detailMetaLabel}>{translate('m.tasks.15ae8aef22', 'Status')}</Text>
        ...
        {detailPayload.provider === 'linear' && detailPayload.project ? (
          <View style={styles.detailMetaItem}>
            <Text style={styles.detailMetaLabel}>{translate('m.tasks.88ce4b1bbf', 'Project')}</Text>
