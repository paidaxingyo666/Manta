  ...
  return (
    <View style={styles.devFacts} pointerEvents="none">
      <Text style={styles.devFactsText} testID="mobile-web-shell-dev-facts">
        {translate(
          'm.MobileWebShellScreen.58e7554411',
          '{{value0}} · {{value1}} B · {{value2}} ms',
          {
            value0: state.buildId.slice(0, BUILD_ID_PREFIX_LENGTH),
            value1: state.totalBytes,
            value2: state.elapsedMs
          }
        )}
      </Text>
    </View>
      ...
      <Waiting
        label={
          state.kind === 'activating'
            ? translate('m.MobileWebShellScreen.e140d1a67b', 'Opening workspace')
