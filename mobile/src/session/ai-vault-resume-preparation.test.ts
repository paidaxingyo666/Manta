...
const LEGACY_CODEX_HOME = '/Users/ada/Library/Application Support/manta/codex-runtime-home/home'
const PER_ACCOUNT_HOME = '/Users/ada/Library/Application Support/manta/codex-accounts/a/home'
...
describe('prepareMobileAiVaultSessionResume', () => {
  ...
  it('uses the real Codex home when a supported desktop requests it', async () => {
    ...
    expect(launch.envToDelete).toEqual(['CODEX_HOME', 'MANTA_CODEX_HOME'])
  })
  ...
  it('repins a per-account session to the home the host substitutes', async () => {
    const substituteHome = '/Users/ada/Library/Application Support/manta/codex-accounts/b/home'
