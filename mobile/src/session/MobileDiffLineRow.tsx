/**
 * One rendered line of a diff, with its inline comment affordance.
 * Split from the session route, which is at its line budget.
 */
import { Pressable, Text, TextInput, View } from 'react-native'
import { Keyboard as MessageSquare, Plus, X } from 'lucide-react-native'
...
import type { RenderableDiffLine } from '../session/mobile-session-route-types'
            ...
            <View key={comment.id} style={styles.diffCommentCard}>
              <View style={styles.diffCommentHeader}>
                ...
                <Text style={styles.diffCommentMeta}>
                  {translate('m.worktreeId.93a3e51407', 'Line')} {comment.lineNumber}
                </Text>
                <Pressable
      ...
      {isCommenting ? (
        <View style={styles.diffCommentComposer}>
          <TextInput
            ...
            placeholder={translate('m.worktreeId.bc2736872c', 'Add review note')}
          ...
          <View style={styles.diffCommentComposerActions}>
            ...
            >
              <Text style={styles.diffCommentSecondaryText}>
                {translate('m.worktreeId.009398e286', 'Cancel')}
              </Text>
            </Pressable>
            <Pressable
              style={[
            ...
            >
              <Text style={styles.diffCommentPrimaryText}>
                {translate('m.worktreeId.6cdae0c3b4', 'Save note')}
              </Text>
            </Pressable>
          </View>
        </View>
