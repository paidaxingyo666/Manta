...
describe('ProtocolBlockScreen', () => {
  ...
  it('keeps the existing protocol wall rendering unchanged', () => {
    ...
    expect(mobile).toContain('Update Manta Mobile')
    expect(mobile).toContain(
      'This desktop needs a newer Manta Mobile app. Update Manta Mobile from the App Store, then try this host again.'
    )
    ...
    expect(desktop).toContain('Update Manta on your computer')
  ...
  it('sends a host without a bundle to the desktop update', () => {
    ...
    expect(output).toContain(
      'This paired desktop app does not include the mobile workspace yet. Update Manta on your computer, then try this host again.'
    )
  ...
  it('sends an unknown manifest schema to the mobile update', () => {
    ...
    expect(output).toContain(
      "This desktop's mobile workspace needs a newer Manta Mobile app. Update Manta Mobile from the App Store, then try this host again."
    )
  ...
  it('sends a host older than its own bundle to the desktop update', () => {
    ...
    expect(output).toContain('Update Manta on your computer')
    expect(output).toContain('This paired desktop app is too old for your current Manta Mobile app')
    expect(primaryActionUrl()).toBe(RELEASES_URL)
  })
