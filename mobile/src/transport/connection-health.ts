...
const SIGNED_OUT_LABEL = 'Desktop signed out — sign in to Manta on your desktop to reconnect'
...
export function classifyConnection(args: {
  ...
  // The relay says the desktop's last control close named its own Manta Cloud
