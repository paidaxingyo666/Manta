...
const GENERATION_STORAGE_KEY = 'manta:pairing-keychain-generation'
const PRESENCE_STORAGE_PREFIX = 'manta:pairing-keychain-presence:'
const SERVICE_PREFIX = 'manta.pairing.v'
