...
const SEND_MODE_FILE = process.env.MOCK_SEND_MODE_FILE ?? join(tmpdir(), 'manta-mock-send-mode')
const TERMINAL_LIST_MODE_FILE =
  process.env.MOCK_TERMINAL_LIST_MODE_FILE ?? join(tmpdir(), 'manta-mock-terminal-list-mode')
...
const TERMINAL_STREAM_MODE_FILE =
  process.env.MOCK_TERMINAL_STREAM_MODE_FILE ?? join(tmpdir(), 'manta-mock-terminal-stream-mode')
