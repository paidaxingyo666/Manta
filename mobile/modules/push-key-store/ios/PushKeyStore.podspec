...
# then returns null forever, no key is ever published, and every push falls back
# to generic text — with nothing logged anywhere.
Pod::Spec.new do |s|
  s.name           = 'PushKeyStore'
  # Hardcoded: this module is local to the app and has no package.json to read.
  s.version        = '1.0.0'
  s.summary        = 'Publishes the push decryption key to the shared keychain group'
