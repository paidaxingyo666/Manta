...
answered, run the exact non-consuming recovery check printed by Manta before
...
launch, preserve the printed `manta-ide` executable and distro route. Older WSL
...
Do not launch a replacement editor merely because Manta updated or authority is
