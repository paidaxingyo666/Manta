...
`.sh` will not execute there. Either require WSL or Git Bash and point `manta.yaml` at a launcher such
as `bash ./scripts/manta-vm/<name>.sh` through a `.cmd` file, or scaffold PowerShell equivalents.
