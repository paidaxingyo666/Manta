import { PUSH_LIMITS, type PushNotification } from '@manta-cloud/push-contract'
...
export function orcaDataStrings(manta: PushOrcaData): Record<string, string> {
  return Object.fromEntries(
    Object.entries(manta)
