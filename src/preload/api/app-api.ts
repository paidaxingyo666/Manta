...
export type AppApi = {
  ...
  /** Restarts Manta through the normal quit pipeline so daemon-backed terminal
  ...
  /** Emits a startup benchmark marker when MANTA_STARTUP_DIAGNOSTICS is enabled. */
  ...
  /** Resolves Manta's app-owned directory for auto-created Floating Workspace
   *  markdown notes. */
