...
describe('getRelayShellLaunchConfig', () => {
  ...
  it.skipIf(process.platform === 'win32')(
    ...
    () => {
      ...
      expect(zshenv).toContain('export MANTA_USER_ZDOTDIR="$_manta_resolved_config_dir"')
