...
// Why: the relay .zshenv republishes the inherited ZDOTDIR as MANTA_USER_ZDOTDIR,
// so later wrapper files prefer it over the spawn-time MANTA_ORIG_ZDOTDIR.
const RELAY_HOME_EXPRESSION = '"${MANTA_USER_ZDOTDIR:-${MANTA_ORIG_ZDOTDIR:-$HOME}}"'
