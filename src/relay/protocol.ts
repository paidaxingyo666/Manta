...
export const RELAY_SENTINEL = `MANTA-RELAY v${RELAY_VERSION} READY\n`
...
const HANDSHAKE_STRING_FIELDS: Readonly<Record<HandshakeMessage['type'], readonly string[]>> = {
  'manta-relay-handshake': ['version'],
  'manta-relay-handshake-ok': ['version'],
  'manta-relay-handshake-mismatch': ['expected', 'got'],
  'manta-relay-handshake-credential-mismatch': []
}
...
> = {
  'manta-relay-handshake': ['endpointCredential'],
  'manta-relay-handshake-ok': [],
  'manta-relay-handshake-mismatch': [],
  'manta-relay-handshake-credential-mismatch': []
}
...
export type GitResponseStreamMarker = {
  __mantaGitResponseStream: { streamId: number; totalBytes: number; chunkCount: number }
}
