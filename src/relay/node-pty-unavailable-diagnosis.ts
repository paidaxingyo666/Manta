 ...
 */
import { GLIBC_FLOOR, nativeSlotName, type NativeHostAbi } from '../main/mantad/native-host-abi'
import {
  classifyNodePtyLoaderMessage,
  isFlattenedNodePtyLoaderMessage
} from '../main/mantad/node-pty-loader-diagnosis'
import {
  ...
  switch (diagnosis.reason) {
    ...
    case 'libc_floor':
      return (
        ...
        `node-pty here; Manta's own Linux floor is glibc ${GLIBC_FLOOR}.`
      )
