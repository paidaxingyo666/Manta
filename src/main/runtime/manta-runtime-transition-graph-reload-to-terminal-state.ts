...
import { MantaRuntimeWithHasTerminalsForWorktree } from './manta-runtime-has-terminals-for-worktree'
...
export class MantaRuntimeWithTransitionGraphReloadToTerminalState extends MantaRuntimeWithHasTerminalsForWorktree {
