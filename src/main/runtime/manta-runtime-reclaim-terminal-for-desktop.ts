...
import { MantaRuntimeWithMobileTookFloor } from './manta-runtime-mobile-took-floor'
import {
  MOBILE_AUTO_RESTORE_FIT_MAX_MS,
  MOBILE_AUTO_RESTORE_FIT_MIN_MS
} from './manta-runtime-postlude'

export class MantaRuntimeWithReclaimTerminalForDesktop extends MantaRuntimeWithMobileTookFloor {
