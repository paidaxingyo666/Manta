...
import { MantaRuntimeWithFitOverrideListeners } from './manta-runtime-fit-override-listeners'
...
export class MantaRuntimeWithTerminalDrivers extends MantaRuntimeWithFitOverrideListeners {
