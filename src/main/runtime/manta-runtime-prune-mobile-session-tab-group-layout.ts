...
import { MantaRuntimeWithScheduleMobileSessionTabsChanged } from './manta-runtime-schedule-mobile-session-tabs-changed'
...
export class MantaRuntimeWithPruneMobileSessionTabGroupLayout extends MantaRuntimeWithScheduleMobileSessionTabsChanged {
