...
const { MantaRuntimeService } = await import('./manta-runtime-test-mocks.spec')
await import('./manta-runtime-test-lifecycle.spec')
const { store, TEST_WORKTREE_ID } = await import('./manta-runtime-test-fixtures.spec')
...
function seedRuntimeWithStoredProof(): {
  runtime: InstanceType<typeof MantaRuntimeService>
