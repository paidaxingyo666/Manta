...
import { MantaRuntimeWithApplyMobileDisplayMode } from './manta-runtime-apply-mobile-display-mode'
...
export class MantaRuntimeWithSubscribeToTerminalResize extends MantaRuntimeWithApplyMobileDisplayMode {
