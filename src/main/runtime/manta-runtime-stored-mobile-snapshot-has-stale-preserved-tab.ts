...
import { MantaRuntimeWithMergePreservedHeadlessMobileSessionTabs } from './manta-runtime-merge-preserved-headless-mobile-session-tabs'
import type {
...
export class MantaRuntimeWithStoredMobileSnapshotHasStalePreservedTab extends MantaRuntimeWithMergePreservedHeadlessMobileSessionTabs {
