...
import { MantaRuntimeWithRefreshFloatingWorkspacePtyLiveness } from './manta-runtime-refresh-floating-workspace-pty-liveness'
...
export class MantaRuntimeWithWriteOrchestrationPointerPty extends MantaRuntimeWithRefreshFloatingWorkspacePtyLiveness {
