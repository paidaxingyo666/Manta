...
import { MantaRuntimeWithHandleMobileSubscribeInternal } from './manta-runtime-handle-mobile-subscribe-internal'

export class MantaRuntimeWithHandleMobileUnsubscribe extends MantaRuntimeWithHandleMobileSubscribeInternal {
