 ...
 * row the user dismissed on the desktop stayed in `manta worktree ps` and on the phone until the
...
function emitWorkingStatus(runtime: MantaRuntimeService, sequence: number): void {
  runtime.onPtyData(
    'dismiss-pty',
