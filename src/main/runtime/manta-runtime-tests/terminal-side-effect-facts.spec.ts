...
import { HEADLESS_RUNTIME_WINDOW_ID, MantaRuntimeService } from '../manta-runtime-test-mocks.spec'
...
import { createSideEffectRuntime } from '../manta-runtime-test-scenario-builders.spec'
...
describe('terminal side-effect fact channel', () => {
  ...
  it('emits pr-link facts once per URL with batch attribution', () => {
    ...
    runtime.onPtyData('pty-1', 'PR https://github.com/acme/manta/pull/4', 100)
    runtime.onPtyData('pty-1', '2\r\nand https://github.com/acme/manta/pull/43 done\r\n', 101)
    // Repeated URL: deduped per PTY, like the renderer byte detector.
    runtime.onPtyData('pty-1', 'again https://github.com/acme/manta/pull/42\r\n', 102)
