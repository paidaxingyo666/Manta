...
describe('MantaRuntimeService', () => {
  ...
  describe('stale terminal handle resolution (#7718)', () => {
    function syncSingleTerminalGraph(runtime: MantaRuntimeService, ptyId: string): void {
    ...
    function issueLeafHandle(runtime: MantaRuntimeService, ptyId: string): string {
