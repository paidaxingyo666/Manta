...
import { createRuntime } from '../manta-runtime-test-fixtures.spec'
...
describe('MantaRuntimeService mobile web bundle capability', () => {
  afterEach(() => {
    resetBundledMobileWebBundleCacheForTests()
  })

  // The mixed-version guarantee: a dev tree or an `manta serve` install that never built
