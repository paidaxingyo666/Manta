...
import { MantaRuntimeWithVisibleSnapshotPreview } from './manta-runtime-visible-snapshot-preview'
...
export class MantaRuntimeWithSerializeHeadlessTerminalBuffer extends MantaRuntimeWithVisibleSnapshotPreview {
