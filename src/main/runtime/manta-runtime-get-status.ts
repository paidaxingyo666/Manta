import { MantaRuntimeWithGetRuntimeId } from './manta-runtime-get-runtime-id'
...
import type { RuntimeWorktreeLifecycleEvent } from './manta-runtime-core'
import { WORKTREE_CREATE_RESULT_TTL_MS } from './manta-runtime-core'
...
export class MantaRuntimeWithGetStatus extends MantaRuntimeWithGetRuntimeId {
  ...
  getStatus(): RuntimeStatus {
    ...
    // Why not a static capability: dev trees and `manta serve` installs may carry no
    ...
    // that actually applies, and a host that says "set MANTA_BROWSER_EXECUTABLE" to someone
