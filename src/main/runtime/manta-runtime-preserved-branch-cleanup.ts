...
import { MantaRuntimeWithTerminalDrivers } from './manta-runtime-terminal-drivers'
...
export class MantaRuntimeWithPreservedBranchCleanup extends MantaRuntimeWithTerminalDrivers {
