...
import { MantaRuntimeWithGetAgentSessionExecutionNamespace } from './manta-runtime-get-agent-session-execution-namespace'
import type {
...
export class MantaRuntimeWithCreateAgentSession extends MantaRuntimeWithGetAgentSessionExecutionNamespace {
  async createAgentSession(
    ...
    const operation = (async (): Promise<RuntimeCreateAgentSessionResult> => {
      ...
      // MANTA_TERMINAL_HANDLE, so it is the only name a lost spawn can be re-found by.
      reclaim.identity = {
