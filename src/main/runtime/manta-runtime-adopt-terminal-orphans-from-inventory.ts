...
import { MantaRuntimeWithSubscribeToTerminalResize } from './manta-runtime-subscribe-to-terminal-resize'
import type {
...
export class MantaRuntimeWithAdoptTerminalOrphansFromInventory extends MantaRuntimeWithSubscribeToTerminalResize {
  ...
  async resolveActiveTerminal(
    ...
    // structured worker is covered by the `MANTA_TERMINAL_HANDLE` its child is spawned with. That
