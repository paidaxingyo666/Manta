...
import { MantaRuntimeWithDeliverPendingMessages } from './manta-runtime-deliver-pending-messages'
...
export class MantaRuntimeWithResolveWaiter extends MantaRuntimeWithDeliverPendingMessages {
