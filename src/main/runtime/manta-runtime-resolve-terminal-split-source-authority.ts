...
import { MantaRuntimeWithSplitPtyBackedTerminal } from './manta-runtime-split-pty-backed-terminal'
import {
...
export class MantaRuntimeWithResolveTerminalSplitSourceAuthority extends MantaRuntimeWithSplitPtyBackedTerminal {
  ...
  async prepareClaudeAgentTeamsLeader(args: {
    ...
    if (!handle) {
      throw new Error('claude_agent_teams_requires_manta_terminal')
    }
