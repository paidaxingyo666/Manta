...
const { MantaRuntimeWithGetOrchestrationDispatchAuthority } =
  await import('./manta-runtime-get-orchestration-dispatch-authority')
const { MantaRuntimeWithVerifyOrchestrationCompatibilityCaller } =
  await import('./manta-runtime-verify-orchestration-compatibility-caller')
const {
...
const getAuthority =
  MantaRuntimeWithGetOrchestrationDispatchAuthority.prototype.getOrchestrationDispatchAuthority
...
const verifyCaller =
  MantaRuntimeWithVerifyOrchestrationCompatibilityCaller.prototype
