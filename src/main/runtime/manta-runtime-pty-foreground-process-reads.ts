...
import { MantaRuntimeWithStateFields } from './manta-runtime-state-fields'
import {
...
export class MantaRuntimeWithPtyForegroundProcessReads extends MantaRuntimeWithStateFields {
