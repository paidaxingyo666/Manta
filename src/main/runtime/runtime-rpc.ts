...
import type { MantaRuntimeRpcServerOptions } from './runtime-rpc/runtime-rpc-pairing-types'
...
export class MantaRuntimeRpcServer extends RuntimeRpcShutdown {
  constructor(options: MantaRuntimeRpcServerOptions) {
    super(options)
  }
}
