...
import { MantaRuntimeWithHasLiveOrPersistedServeOrSshOwnedPtyBinding } from './manta-runtime-has-live-or-persisted-serve-or-ssh-owned-pty-binding'
...
export class MantaRuntimeWithPublishPtyBackedMobileSessionTerminal extends MantaRuntimeWithHasLiveOrPersistedServeOrSshOwnedPtyBinding {
  /**
