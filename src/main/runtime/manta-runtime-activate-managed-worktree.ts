...
export class MantaRuntimeWithActivateManagedWorktree extends MantaRuntimeWithListManagedWorktrees {
  async activateManagedWorktree(
     ...
     *  renderer holds the sleeping records (headless `manta serve`), so nothing
