...
import { MantaRuntimeWithStructuredAgentSessionLaunchTui } from './manta-runtime-structured-agent-session-launch-tui'
...
export class MantaRuntimeWithStructuredAgentSessionReproveTuiOwner extends MantaRuntimeWithStructuredAgentSessionLaunchTui {
