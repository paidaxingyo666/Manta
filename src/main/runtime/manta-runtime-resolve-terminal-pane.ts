...
import { MantaRuntimeWithGetTerminalInteractiveWait } from './manta-runtime-get-terminal-interactive-wait'
import type {
  RuntimeTerminalRead,
...
export class MantaRuntimeWithResolveTerminalPane extends MantaRuntimeWithGetTerminalInteractiveWait {
