...
import { MantaRuntimeWithResolveKnownWorkspaceFileTarget } from './manta-runtime-resolve-known-workspace-file-target'
import type { PtyIncarnationId } from '../../shared/pty-incarnation'

export class MantaRuntimeWithInvalidateAllHandlesForPty extends MantaRuntimeWithResolveKnownWorkspaceFileTarget {
