...
import { MantaRuntimeWithStructuredAgentSessionReproveTuiOwner } from './manta-runtime-structured-agent-session-reprove-tui-owner'
...
export class MantaRuntimeWithStructuredAgentSessionRecoverTuiOwner extends MantaRuntimeWithStructuredAgentSessionReproveTuiOwner {
