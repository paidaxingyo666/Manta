...
import { MantaRuntimeWithRefuseUnattributedMobileSessionTabClose } from './manta-runtime-refuse-unattributed-mobile-session-tab-close'
import type {
...
export class MantaRuntimeWithCloseMobileSessionTab extends MantaRuntimeWithRefuseUnattributedMobileSessionTabClose {
