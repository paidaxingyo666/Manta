...
import { MantaRuntimeWithHandleMobileUnsubscribe } from './manta-runtime-handle-mobile-unsubscribe'

export class MantaRuntimeWithApplyMobileDisplayMode extends MantaRuntimeWithHandleMobileUnsubscribe {
