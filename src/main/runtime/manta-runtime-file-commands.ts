...
import { MantaRuntimeWithPreservedBranchCleanup } from './manta-runtime-preserved-branch-cleanup'
import { RuntimeFileCommands } from './manta-runtime-files'
...
import { RuntimeGitCommands } from './manta-runtime-git'
...
export class MantaRuntimeWithFileCommands extends MantaRuntimeWithPreservedBranchCleanup {
