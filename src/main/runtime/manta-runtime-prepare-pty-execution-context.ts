...
import { MantaRuntimeWithRegisterPty } from './manta-runtime-register-pty'
...
export class MantaRuntimeWithPreparePtyExecutionContext extends MantaRuntimeWithRegisterPty {
