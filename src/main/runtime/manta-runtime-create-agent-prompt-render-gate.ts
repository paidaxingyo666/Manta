...
import { MantaRuntimeWithWriteTerminalAgentPrompt } from './manta-runtime-write-terminal-agent-prompt'
import {
...
export class MantaRuntimeWithCreateAgentPromptRenderGate extends MantaRuntimeWithWriteTerminalAgentPrompt {
