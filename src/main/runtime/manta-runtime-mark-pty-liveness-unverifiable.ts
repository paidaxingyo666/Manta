...
import { MantaRuntimeWithOnPtyExit } from './manta-runtime-on-pty-exit'
...
export class MantaRuntimeWithMarkPtyLivenessUnverifiable extends MantaRuntimeWithOnPtyExit {
  /**
  ...
  /**
   * Records that Manta asked this PTY to stop — a close, a stop, a teardown.
   *
