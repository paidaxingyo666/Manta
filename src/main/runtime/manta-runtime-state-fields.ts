...
import { MantaRuntimeWithLinearCommands } from './manta-runtime-linear-commands'
...
export class MantaRuntimeWithStateFields extends MantaRuntimeWithLinearCommands {
  ...
  constructor(
    ...
    deps?: {
      ...
      // differs per host (scanner child on the desktop, in-process on mantad), and on mantad
