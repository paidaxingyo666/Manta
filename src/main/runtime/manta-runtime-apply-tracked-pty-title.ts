...
import { MantaRuntimeWithGetUnpersistedTrackedTitleForPty } from './manta-runtime-get-unpersisted-tracked-title-for-pty'
...
export class MantaRuntimeWithApplyTrackedPtyTitle extends MantaRuntimeWithGetUnpersistedTrackedTitleForPty {
