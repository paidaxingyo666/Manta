...
import { MantaRuntimeWithGetWorktreePs } from './manta-runtime-get-worktree-ps'
...
export class MantaRuntimeWithProveRecoveredStructuredTuiPtyProcess extends MantaRuntimeWithGetWorktreePs {
