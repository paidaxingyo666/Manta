...
import { MantaRuntimeWithRefreshRepoWorktreeScan } from './manta-runtime-refresh-repo-worktree-scan'
...
export class MantaRuntimeWithRecordPtyWorktree extends MantaRuntimeWithRefreshRepoWorktreeScan {
