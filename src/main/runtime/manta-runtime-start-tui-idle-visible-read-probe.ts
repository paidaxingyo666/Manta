...
import { MantaRuntimeWithCreateAgentPromptRenderGate } from './manta-runtime-create-agent-prompt-render-gate'
import type {
...
export class MantaRuntimeWithStartTuiIdleVisibleReadProbe extends MantaRuntimeWithCreateAgentPromptRenderGate {
