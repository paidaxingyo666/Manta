...
import { MantaRuntimeWithWaitForLeafPtyId } from './manta-runtime-wait-for-leaf-pty-id'
...
export class MantaRuntimeWithFocusTerminal extends MantaRuntimeWithWaitForLeafPtyId {
  async focusTerminal(
    handle: string,
