...
import { MantaRuntimeWithOnClientDisconnected } from './manta-runtime-on-client-disconnected'
...
export class MantaRuntimeWithOnPtyExit extends MantaRuntimeWithOnClientDisconnected {
  onPtyExit(
    ptyId: string,
    exitCode: number,
