...
import { MantaRuntimeWithPersistHeadlessTerminalTitle } from './manta-runtime-persist-headless-terminal-title'
import type { ExecutionHostId } from '../../shared/execution-host'
import type { ResolvedWorktree } from './runtime-worktree-path-identity'
import { getRuntimeFileTargetExecutionHostId } from './manta-runtime-files'
import { findRuntimeWorkspaceFileOwner } from '../../shared/runtime-workspace-file-owner'
import type { RuntimeMobileSessionTabsResult } from '../../shared/runtime-types'
import { randomUUID } from 'node:crypto'
import type { PtyIncarnationId } from '../../shared/pty-incarnation'

export class MantaRuntimeWithResolveKnownWorkspaceFileTarget extends MantaRuntimeWithPersistHeadlessTerminalTitle {
  ...
  // RPC, but agents need their own handle at spawn time (via MANTA_TERMINAL_HANDLE
  ...
  protected adoptControllerTerminalHandle(
    ...
    // original MANTA_TERMINAL_HANDLE, but the runtime's in-memory map is gone.
