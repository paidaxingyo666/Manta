...
import { MantaRuntimeWithSleepResolvedWorktreeTerminals } from './manta-runtime-sleep-resolved-worktree-terminals'
import { setsEqual } from './runtime-worktree-binding-index'
import { runtimeWorktreeIdsEqual } from './runtime-worktree-path-identity'

export class MantaRuntimeWithStopExactTerminalsForWorktree extends MantaRuntimeWithSleepResolvedWorktreeTerminals {
