...
import { MantaRuntimeWithMaybeHydrateHeadlessFromRenderer } from './manta-runtime-maybe-hydrate-headless-from-renderer'
...
export class MantaRuntimeWithCreatePtyHeadlessTerminalState extends MantaRuntimeWithMaybeHydrateHeadlessFromRenderer {
