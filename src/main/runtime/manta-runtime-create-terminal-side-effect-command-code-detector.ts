...
import { MantaRuntimeWithApplyTrackedPtyTitle } from './manta-runtime-apply-tracked-pty-title'
import type {
...
export class MantaRuntimeWithCreateTerminalSideEffectCommandCodeDetector extends MantaRuntimeWithApplyTrackedPtyTitle {
