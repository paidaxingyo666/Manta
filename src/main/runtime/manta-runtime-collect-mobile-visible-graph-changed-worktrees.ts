...
import { MantaRuntimeWithSyncWindowGraph } from './manta-runtime-sync-window-graph'
...
export class MantaRuntimeWithCollectMobileVisibleGraphChangedWorktrees extends MantaRuntimeWithSyncWindowGraph {
