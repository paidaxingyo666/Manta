...
import { MantaRuntimeWithCreateTerminalSideEffectCommandCodeDetector } from './manta-runtime-create-terminal-side-effect-command-code-detector'
import type { AgentStatus } from '../../shared/agent-detection'
import { findLastCompleteOscTitleRange } from './manta-runtime-core'
...
export class MantaRuntimeWithRecordAgentPromptLifecycleState extends MantaRuntimeWithCreateTerminalSideEffectCommandCodeDetector {
