...
const MantaRuntimeServiceExport = MantaRuntimeService as unknown as {
  ...
  readonly prototype: MantaRuntimeServiceExport
}
export { MantaRuntimeServiceExport as MantaRuntimeService }
installRuntimeLinearCommandSurface(MantaRuntimeServiceExport.prototype)
...
export { projectTerminalTailLines } from './manta-runtime-terminal-projection'
