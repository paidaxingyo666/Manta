...
const { MantaRuntimeWithResolveTerminalPane } = await import('./manta-runtime-resolve-terminal-pane')
const {
...
describe('reading a structured worker through the terminal-read path', () => {
  ...
  it('is what `terminal read` answers with, ahead of the PTY lookup', async () => {
    ...
    const runtime = Object.assign(Object.create(MantaRuntimeWithResolveTerminalPane.prototype), {
