...
import { MantaRuntimeWithPersistHeadlessSessionTabProps } from './manta-runtime-persist-headless-session-tab-props'
import type {
...
export class MantaRuntimeWithMoveHeadlessMobileSessionTab extends MantaRuntimeWithPersistHeadlessSessionTabProps {
