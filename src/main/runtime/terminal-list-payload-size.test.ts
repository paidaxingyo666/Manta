...
const WORKTREE_PATH = '/Users/dev/manta/workspaces/manta/perf-terminal-list-diet'
...
const titleFor = (index: number): string => `claude — manta/perf-terminal-list-diet #${index}`
...
function buildLoadedRuntime(): MantaRuntimeService {
