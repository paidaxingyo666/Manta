...
export class MantaRuntimeWithRuntimeId {
  ...
  /** The agent Manta believes owns this pane, for tui-idle evidence ranking. Launch
   *  authority first; the live foreground agent covers panes Manta did not launch. */
