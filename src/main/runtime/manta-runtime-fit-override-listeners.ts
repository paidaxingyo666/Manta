...
import { MantaRuntimeWithStopRequestedPtyIds } from './manta-runtime-stop-requested-pty-ids'
...
export class MantaRuntimeWithFitOverrideListeners extends MantaRuntimeWithStopRequestedPtyIds {
