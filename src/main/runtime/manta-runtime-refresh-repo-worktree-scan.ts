...
import { MantaRuntimeWithListKnownResolvedWorktreesForExplicitTarget } from './manta-runtime-list-known-resolved-worktrees-for-explicit-target'
import type { Repo } from '../../shared/repo-types'
import type { ProjectExecutionRuntimeResolution } from '../../shared/project-execution-runtime'
import type { RuntimeWorktreeScanCache, RuntimeWorktreeScanRefresh } from './manta-runtime-core'
...
export class MantaRuntimeWithRefreshRepoWorktreeScan extends MantaRuntimeWithListKnownResolvedWorktreesForExplicitTarget {
  /**
