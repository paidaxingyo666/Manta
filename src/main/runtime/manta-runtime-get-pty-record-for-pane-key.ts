...
import { MantaRuntimeWithPruneMobileSessionTabGroupLayout } from './manta-runtime-prune-mobile-session-tab-group-layout'
...
export class MantaRuntimeWithGetPtyRecordForPaneKey extends MantaRuntimeWithPruneMobileSessionTabGroupLayout {
