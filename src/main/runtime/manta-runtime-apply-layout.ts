...
import { MantaRuntimeWithPickMostRecentActor } from './manta-runtime-pick-most-recent-actor'
import type { ApplyLayoutResult, PtyLayoutState, PtyLayoutTarget } from './manta-runtime-core'

export class MantaRuntimeWithApplyLayout extends MantaRuntimeWithPickMostRecentActor {
