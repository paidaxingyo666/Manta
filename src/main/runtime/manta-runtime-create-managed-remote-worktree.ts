...
import { MantaRuntimeWithCreateManagedWorktree } from './manta-runtime-create-managed-worktree'
...
export class MantaRuntimeWithCreateManagedRemoteWorktree extends MantaRuntimeWithCreateManagedWorktree {
