...
import { MantaRuntimeWithMarkPtyLivenessUnverifiable } from './manta-runtime-mark-pty-liveness-unverifiable'
import type { ApplyLayoutResult, DriverState } from './manta-runtime-core'
import { clampTerminalViewport } from './terminal-viewport'

export class MantaRuntimeWithMobileTookFloor extends MantaRuntimeWithMarkPtyLivenessUnverifiable {
