...
import { MantaRuntimeWithReclaimTerminalForDesktop } from './manta-runtime-reclaim-terminal-for-desktop'
import type { ApplyLayoutResult, PtyLayoutState, PtyLayoutTarget } from './manta-runtime-core'

export class MantaRuntimeWithPickMostRecentActor extends MantaRuntimeWithReclaimTerminalForDesktop {
