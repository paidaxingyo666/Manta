...
import { MantaRuntimeWithPublishPtyBackedMobileSessionTerminal } from './manta-runtime-publish-pty-backed-mobile-session-terminal'
...
export class MantaRuntimeWithTouchMobileSessionTabsForWorktree extends MantaRuntimeWithPublishPtyBackedMobileSessionTerminal {
