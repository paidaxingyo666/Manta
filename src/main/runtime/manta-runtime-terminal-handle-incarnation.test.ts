...
function makeRuntime(): { runtime: MantaRuntimeService; writes: string[] } {
  const writes: string[] = []
...
function syncGraph(runtime: MantaRuntimeService): void {
...
function register(runtime: MantaRuntimeService, incarnationId: string): void {
