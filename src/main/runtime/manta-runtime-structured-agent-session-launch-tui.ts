...
import { MantaRuntimeWithStartTuiIdleVisibleReadProbe } from './manta-runtime-start-tui-idle-visible-read-probe'
...
export class MantaRuntimeWithStructuredAgentSessionLaunchTui extends MantaRuntimeWithStartTuiIdleVisibleReadProbe {
