...
import { MantaRuntimeWithSerializeMainTerminalBuffer } from './manta-runtime-serialize-main-terminal-buffer'
...
export class MantaRuntimeWithMaybeHydrateHeadlessFromRenderer extends MantaRuntimeWithSerializeMainTerminalBuffer {
