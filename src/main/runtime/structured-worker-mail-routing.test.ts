...
const { MantaRuntimeWithAdoptTerminalOrphansFromInventory } =
  await import('./manta-runtime-adopt-terminal-orphans-from-inventory')
const {
...
const prototype = MantaRuntimeWithAdoptTerminalOrphansFromInventory.prototype
