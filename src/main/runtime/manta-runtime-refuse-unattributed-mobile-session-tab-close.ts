...
import { MantaRuntimeWithApplyMobileSessionTabNavigation } from './manta-runtime-apply-mobile-session-tab-navigation'
import type { RuntimeMobileSessionTabCloseResult } from '../../shared/runtime-types'

export class MantaRuntimeWithRefuseUnattributedMobileSessionTabClose extends MantaRuntimeWithApplyMobileSessionTabNavigation {
