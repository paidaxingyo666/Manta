...
// `MantaRuntimeService.fetchRemoteWithCache` — in particular that a rejected
...
// without disturbing the large manta-runtime.test.ts mock surface.
...
// Why: manta-runtime.ts imports heavy modules (hooks, ipc/*, etc.) at top
...
describe('MantaRuntimeService.fetchRemoteWithCache', () => {
  beforeEach(() => {
