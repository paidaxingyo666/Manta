...
import { MantaRuntimeWithApplyLayout } from './manta-runtime-apply-layout'

export class MantaRuntimeWithHandleMobileSubscribe extends MantaRuntimeWithApplyLayout {
