...
import { MantaRuntimeWithControllerKnowsPtyIsLive } from './manta-runtime-controller-knows-pty-is-live'
...
export class MantaRuntimeWithSerializeAgentPromptSubmission extends MantaRuntimeWithControllerKnowsPtyIsLive {
