...
import { MantaRuntimeWithGetWorktreeTerminalProvisioningHost } from './manta-runtime-get-worktree-terminal-provisioning-host'
...
export class MantaRuntimeWithCreateManagedWorktree extends MantaRuntimeWithGetWorktreeTerminalProvisioningHost {
