...
import { MantaRuntimeWithTouchMobileSessionTabsForWorktree } from './manta-runtime-touch-mobile-session-tabs-for-worktree'
...
export class MantaRuntimeWithPersistTerminalSurfaceRetirements extends MantaRuntimeWithTouchMobileSessionTabsForWorktree {
  /**
