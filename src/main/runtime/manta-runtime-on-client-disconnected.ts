...
import { MantaRuntimeWithHasRecentTerminalOutputPath } from './manta-runtime-has-recent-terminal-output-path'
import type { RuntimeCommandSurfaceHost } from './manta-runtime-core'

export class MantaRuntimeWithOnClientDisconnected extends MantaRuntimeWithHasRecentTerminalOutputPath {
