import type { SubscriptionRegistration } from '../manta-runtime'
...
/**
 * Faithful double of the runtime subscription registry (`MantaRuntimeService`,
 ...
 * `manta-runtime.test.ts` are what pin the real behavior; these doubles only pin routing.
 *
