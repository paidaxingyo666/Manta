...
// a real MantaRuntimeService, because a relay drop reaches the phone through the predicate.
...
function makeRelayDroppedRuntime(): MantaRuntimeService {
  const real = new MantaRuntimeService()
...
function createRuntime(real: MantaRuntimeService): {
