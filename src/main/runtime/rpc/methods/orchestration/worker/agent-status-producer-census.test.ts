...
const CENSUS: readonly CensusRow[] = [
  ...
  {
    path: 'main/runtime/manta-runtime-preserved-branch-cleanup.ts',
    kind: 'wiring',
    role: 'declares the snapshot dep fields'
  },
  {
    path: 'main/runtime/manta-runtime-get-orchestration-dispatch-authority.ts',
    kind: 'produces',
    role: 'getOrchestrationFleetAgentStatusSnapshot — delegates to the checked snapshot module'
  },
  {
    path: 'main/runtime/manta-runtime-stop-requested-pty-ids.ts',
    kind: 'wiring',
  ...
  {
    path: 'main/runtime/manta-runtime-get-worktree-ps.ts',
    kind: 'consumes',
    role: 'worktree.ps inline agent rows (driven below)'
  },
  {
    path: 'main/runtime/manta-runtime-get-terminal-interactive-wait.ts',
    kind: 'consumes',
    role: 'exact-worker provider session selection, matched on pane key'
  },
  {
    path: 'main/runtime/manta-runtime-serialize-agent-prompt-submission.ts',
    kind: 'consumes',
    role: 'prompt-submission serialization, matched on pane key'
  },
  {
    path: 'main/runtime/manta-runtime-resolve-recovered-structured-tui-transcript.ts',
    kind: 'consumes',
...
function censusRuntime(): MantaRuntimeService {
...
describe('agent status producer census', () => {
  ...
  it('lists a worktree.ps agent row from a hook row that carries only a pane key', async () => {
    ...
    const runtime = new MantaRuntimeService(censusStore() as never, undefined, {
