 ...
 * is not "whatever ships in this build": it is the `manta` CLI over the runtime socket and the
...
async function agentLaunchTarget(
  ...
  runtime: Pick<MantaRuntimeService, 'showTerminalWorkspaceLaunchScope'>
...
async function validateReusedTerminal(
  ...
  runtime: Pick<MantaRuntimeService, 'showTerminal' | 'isTerminalRunningAgent'>
): Promise<void> {
...
function activeAgentLaunchesFor(runtime: MantaRuntimeService): Map<string, ActiveAgentLaunch> {
