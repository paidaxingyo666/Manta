 ...
 * called solely from `MantaRuntimeService.closeTerminal` (the explicit user-close IPC).
...
function registerTeam(runtime: MantaRuntimeService, ptyId: string, leaderHandle: string): void {
