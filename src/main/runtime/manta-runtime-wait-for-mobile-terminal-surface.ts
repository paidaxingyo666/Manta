...
import { MantaRuntimeWithCreateRuntimeOwnedMobileSessionTerminal } from './manta-runtime-create-runtime-owned-mobile-session-terminal'
import type {
  RuntimeMobileSessionCreateTerminalResult,
  RuntimeMobileSessionTerminalClientTab
} from '../../shared/runtime-types'
import { MOBILE_TERMINAL_SURFACE_TIMEOUT_MS } from './manta-runtime-core'
...
export class MantaRuntimeWithWaitForMobileTerminalSurface extends MantaRuntimeWithCreateRuntimeOwnedMobileSessionTerminal {
