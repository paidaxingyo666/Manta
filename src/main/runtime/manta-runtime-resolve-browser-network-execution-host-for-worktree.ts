...
import { MantaRuntimeWithTransitionGraphReloadToTerminalState } from './manta-runtime-transition-graph-reload-to-terminal-state'
...
import type { ResolvedTerminalWorkspaceLaunchTarget } from './manta-runtime-core'
import { AGENT_HOOK_RUNTIME_ENV_KEYS } from './manta-runtime-core'
...
export class MantaRuntimeWithResolveBrowserNetworkExecutionHostForWorktree extends MantaRuntimeWithTransitionGraphReloadToTerminalState {
  ...
  protected buildTerminalWorkspaceEnv(
    ...
    return {
      ...env,
      MANTA_WORKSPACE_ID: scope.id,
      MANTA_PROJECT_GROUP_ID: scope.folderWorkspace.projectGroupId,
      MANTA_WORKSPACE_ROOT: scope.folderWorkspace.folderPath
    }
  }
