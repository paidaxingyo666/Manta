...
import { MantaRuntimeWithPerformMobileSessionPtyRecordsRefresh } from './manta-runtime-perform-mobile-session-pty-records-refresh'
import type {
...
export class MantaRuntimeWithApplyMobileSessionTabNavigation extends MantaRuntimeWithPerformMobileSessionPtyRecordsRefresh {
