...
import { MantaRuntimeWithResolveMobileSessionTerminalCommand } from './manta-runtime-resolve-mobile-session-terminal-command'
...
export class MantaRuntimeWithCreateRuntimeOwnedMobileSessionTerminal extends MantaRuntimeWithResolveMobileSessionTerminalCommand {
