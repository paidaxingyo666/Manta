...
import { MantaRuntimeWithCloseHeadlessMobileTerminalTab } from './manta-runtime-close-headless-mobile-terminal-tab'
...
export class MantaRuntimeWithPersistHeadlessSessionTabProps extends MantaRuntimeWithCloseHeadlessMobileTerminalTab {
