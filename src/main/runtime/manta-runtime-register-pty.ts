...
import { MantaRuntimeWithInvalidateAllHandlesForPty } from './manta-runtime-invalidate-all-handles-for-pty'
...
export class MantaRuntimeWithRegisterPty extends MantaRuntimeWithInvalidateAllHandlesForPty {
  registerPty(
    ptyId: string,
    worktreeId: string,
