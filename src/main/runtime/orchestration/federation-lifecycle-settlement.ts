...
const waitersByRuntime = new WeakMap<MantaRuntimeService, Map<string, Set<Waiter>>>()
...
function getRuntimeWaiters(runtime: MantaRuntimeService): Map<string, Set<Waiter>> {
