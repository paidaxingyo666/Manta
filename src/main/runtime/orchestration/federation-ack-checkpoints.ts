...
const federationAckStates = new WeakMap<MantaRuntimeService, FederationAckRuntimeState>()

export function clearFederationAckCheckpoints(runtime: MantaRuntimeService): void {
