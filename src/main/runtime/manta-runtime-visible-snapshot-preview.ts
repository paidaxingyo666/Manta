...
import { MantaRuntimeWithCaptureProviderTerminalBuffer } from './manta-runtime-capture-provider-terminal-buffer'
...
export class MantaRuntimeWithVisibleSnapshotPreview extends MantaRuntimeWithCaptureProviderTerminalBuffer {
