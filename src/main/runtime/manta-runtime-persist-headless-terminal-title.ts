...
import { MantaRuntimeWithMoveHeadlessMobileSessionTab } from './manta-runtime-move-headless-mobile-session-tab'
import type {
...
export class MantaRuntimeWithPersistHeadlessTerminalTitle extends MantaRuntimeWithMoveHeadlessMobileSessionTab {
