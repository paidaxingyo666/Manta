...
import { MantaRuntimeWithGetOrchestrationDispatchAuthority } from './manta-runtime-get-orchestration-dispatch-authority'
import {
  recentTerminalOutputIncludesPath,
  recentTerminalPathCandidatesIncludePath
} from './terminal-output-path-candidates'
import type { ApplyLayoutResult, DriverState } from './manta-runtime-core'
import { clampTerminalViewport } from './terminal-viewport'

export class MantaRuntimeWithHasRecentTerminalOutputPath extends MantaRuntimeWithGetOrchestrationDispatchAuthority {
