...
import { MantaRuntimeWithScheduleWaitBlockedCheck } from './manta-runtime-schedule-wait-blocked-check'
...
export class MantaRuntimeWithEmitDaemonPtyTransientFact extends MantaRuntimeWithScheduleWaitBlockedCheck {
  ...
  getTerminalSideEffectSnapshot(ptyId: string): TerminalSideEffectBatch | null {
    ...
    // tracker title Manta synthesized from hooks — but with no tracker title it is the pane's
