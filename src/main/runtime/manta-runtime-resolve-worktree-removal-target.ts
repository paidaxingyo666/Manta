...
import { MantaRuntimeWithRemoveManagedWorktree } from './manta-runtime-remove-managed-worktree'
...
export class MantaRuntimeWithResolveWorktreeRemovalTarget extends MantaRuntimeWithRemoveManagedWorktree {
