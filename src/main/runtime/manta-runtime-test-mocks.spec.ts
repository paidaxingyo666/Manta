...
import * as setup from './manta-runtime-test-mocks/setup.spec'
import * as importedValues from './manta-runtime-test-mocks/imported-values.spec'
...
export const MantaRuntimeService = importedValues.exportedMantaRuntimeService
...
export const parseMantaYaml = importedValues.exportedParseMantaYaml
...
} from './manta-runtime-test-mocks/setup.spec'
...
export { electronMocks } from './manta-runtime-test-mocks/setup.spec'
export {
...
export type MantaRuntimeService = InstanceType<typeof importedValues.exportedMantaRuntimeService>
...
export type { RuntimeTerminalAgentStatusEvent } from './manta-runtime'
