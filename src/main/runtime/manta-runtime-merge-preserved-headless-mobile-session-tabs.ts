...
import { MantaRuntimeWithSyncMobileSessionTabs } from './manta-runtime-sync-mobile-session-tabs'
import type {
...
export class MantaRuntimeWithMergePreservedHeadlessMobileSessionTabs extends MantaRuntimeWithSyncMobileSessionTabs {
