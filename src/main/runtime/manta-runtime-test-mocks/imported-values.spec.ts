...
import { getEffectiveHooks, hasHooksFile, loadHooks, parseMantaYaml, runHook } from '../../hooks'
...
import {
  ...
  buildPreview,
  MantaRuntimeService as MantaRuntimeServiceConstructor,
...
export const exportedMantaRuntimeService = MantaRuntimeServiceConstructor
...
export const exportedParseMantaYaml = parseMantaYaml
