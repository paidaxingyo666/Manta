...
import { MantaRuntimeWithStopStructuredSessionProcess } from './manta-runtime-stop-structured-session-process'
...
export class MantaRuntimeWithResolveRecoveredStructuredTuiTranscript extends MantaRuntimeWithStopStructuredSessionProcess {
