...
import { MantaRuntimeWithStoredMobileSnapshotHasStalePreservedTab } from './manta-runtime-stored-mobile-snapshot-has-stale-preserved-tab'
import type {
  BrowserTabInfo,
...
export class MantaRuntimeWithScheduleMobileSessionTabsChanged extends MantaRuntimeWithStoredMobileSnapshotHasStalePreservedTab {
