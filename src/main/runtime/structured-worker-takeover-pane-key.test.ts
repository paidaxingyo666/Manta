...
const { MantaRuntimeWithGetPtyRecordForPaneKey } =
  await import('./manta-runtime-get-pty-record-for-pane-key')
const {
...
function runtime() {
  return Object.assign(Object.create(MantaRuntimeWithGetPtyRecordForPaneKey.prototype), {
