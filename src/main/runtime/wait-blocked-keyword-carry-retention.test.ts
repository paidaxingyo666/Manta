...
import { WAIT_BLOCKED_KEYWORD_CARRY_CHARS } from './manta-runtime-postlude'
...
function createScheduleHost(): ScheduleHost {
  const prototype = MantaRuntimeWithScheduleWaitBlockedCheck.prototype as unknown as ScheduleHost
  return {
