...
import { MantaRuntimeWithRefreshPtyWorktreeRecordsWithControllerInventory } from './manta-runtime-refresh-pty-worktree-records-with-controller-inventory'
import { FLOATING_TERMINAL_WORKTREE_ID } from '../../shared/constants'
import { isTerminalLeafId, makePaneKey } from '../../shared/stable-pane-id'
import type { RuntimeLeafRecord, RuntimePtyWorktreeRecord } from './runtime-terminal-state-records'
import { DISCONNECTED_PTY_RECORD_MAX } from './manta-runtime-postlude'

export class MantaRuntimeWithRefreshFloatingWorkspacePtyLiveness extends MantaRuntimeWithRefreshPtyWorktreeRecordsWithControllerInventory {
