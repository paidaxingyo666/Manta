...
import { MantaRuntimeWithCollectMobileVisibleGraphChangedWorktrees } from './manta-runtime-collect-mobile-visible-graph-changed-worktrees'

export class MantaRuntimeWithWaitForSessionTabsInventoryPublication extends MantaRuntimeWithCollectMobileVisibleGraphChangedWorktrees {
