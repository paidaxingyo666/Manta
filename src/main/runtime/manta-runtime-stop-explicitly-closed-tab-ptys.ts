...
import { MantaRuntimeWithFocusTerminal } from './manta-runtime-focus-terminal'
import { EXPLICIT_TERMINAL_CLOSE_STOP_TIMEOUT_MS } from './manta-runtime-core'
...
export class MantaRuntimeWithStopExplicitlyClosedTabPtys extends MantaRuntimeWithFocusTerminal {
