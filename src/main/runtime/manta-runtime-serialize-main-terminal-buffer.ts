...
import { MantaRuntimeWithAttachRemoteTerminalSourceRangeConsumer } from './manta-runtime-attach-remote-terminal-source-range-consumer'
...
export class MantaRuntimeWithSerializeMainTerminalBuffer extends MantaRuntimeWithAttachRemoteTerminalSourceRangeConsumer {
