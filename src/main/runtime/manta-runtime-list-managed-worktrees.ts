...
import { MantaRuntimeWithRestoreStructuredAgentSessionTabsOnce } from './manta-runtime-restore-structured-agent-session-tabs-once'
import { DEFAULT_WORKTREE_LIST_LIMIT } from './manta-runtime-postlude'
...
export class MantaRuntimeWithListManagedWorktrees extends MantaRuntimeWithRestoreStructuredAgentSessionTabsOnce {
