...
import { MantaRuntimeWithResolveAuthoritativeTerminalWaitPermission } from './manta-runtime-resolve-authoritative-terminal-wait-permission'
...
export class MantaRuntimeWithWriteTerminalAgentPrompt extends MantaRuntimeWithResolveAuthoritativeTerminalWaitPermission {
  protected async writeTerminalAgentPrompt(
    ...
    // receipt; they must not fail a Dispatch merely because Manta cannot prove
