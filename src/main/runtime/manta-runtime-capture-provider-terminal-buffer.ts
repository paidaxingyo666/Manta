...
import { MantaRuntimeWithSerializeTerminalBufferFromAvailableState } from './manta-runtime-serialize-terminal-buffer-from-available-state'
...
import type { RuntimeTerminalProjection } from './manta-runtime-core'
import { DEFAULT_TERMINAL_READ_LIMIT } from './terminal-tail-limits'
import { HeadlessEmulator } from '../daemon/headless-emulator'
import { projectTerminalTailLines } from './manta-runtime-terminal-projection'

export class MantaRuntimeWithCaptureProviderTerminalBuffer extends MantaRuntimeWithSerializeTerminalBufferFromAvailableState {
