...
import { getMantaProfileDirectory } from '../manta-profiles/profile-storage-paths'
...
function intentDirectory(profileId: string, userDataPath: string): string {
  return join(getMantaProfileDirectory(profileId, userDataPath), 'artifact-create-intents')
}
