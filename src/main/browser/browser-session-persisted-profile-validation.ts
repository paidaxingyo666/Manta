import { getMantaProfileBrowserSessionPartition } from '../../shared/manta-profiles'
...
export function isValidPersistedBrowserSessionProfile(
  ...
  return (
    ...
    isProfileOwnedSessionPartition(candidate.id, candidate.partition, activeMantaProfileId)
  )
}
...
export function inspectRetiredBrowserSessionProfileUserAgentModes(
  ...
  for (const profile of profiles) {
    ...
    if (
      ...
      !isValidPersistedBrowserSessionProfile(profile, activeMantaProfileId)
    ) {
      degraded = true
    }
  }
...
function isProfileOwnedSessionPartition(
  ...
  return (
    ...
    partition === getMantaProfileBrowserSessionPartition(activeMantaProfileId, profileId)
  )
}
