...
/**
 * Hosts a guest-opened popup inside a Manta-built window whose top strip is a
 * separate, Manta-controlled WebContentsView showing the popup's current
...
export function openPopupWithOriginBar(
  ...
  // Why: the origin bar renders only Manta's own data: URL and must stay
