...
// Why not "the whole object is empty": manta-status.json is Manta-owned, so once no hook entries
...
export function isMantaOwnedRemnant(config: HooksConfig): boolean {
