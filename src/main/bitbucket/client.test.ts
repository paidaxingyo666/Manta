...
describe('Bitbucket client', () => {
  beforeEach(() => {
    process.env = { ...OLD_ENV }
    process.env.MANTA_BITBUCKET_API_BASE_URL = 'https://api.test.local/2.0'
    process.env.MANTA_BITBUCKET_EMAIL = 'user@example.com'
    process.env.MANTA_BITBUCKET_API_TOKEN = 'token'
    delete process.env.MANTA_BITBUCKET_ACCESS_TOKEN
