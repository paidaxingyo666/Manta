...
describe('getPRForBranch', () => {
  ...
  it('reports upstream error when fallback branch discovery fails transiently then retry misses', async () => {
    resolvePRRepositoryCandidatesMock.mockResolvedValueOnce({
      candidates: [{ owner: 'stablyai', repo: 'manta' }],
      headRepo: null
    })
    ghExecFileAsyncMock
    ...
    expect(ghExecFileAsyncMock).toHaveBeenNthCalledWith(
      2,
      ['api', 'repos/stablyai/manta/pulls?head=stablyai%3Afeature%2Ftest&state=all&per_page=1'],
      { cwd: '/repo-root' }
    )
  })
        ...
        stdout: JSON.stringify([
          {
            ...
            state: 'open',
            html_url: 'https://github.com/stablyai/manta/pull/42',
            updated_at: '2026-03-28T00:00:00Z',
            draft: false,
            mergeable: true,
    ...
    ghExecFileAsyncMock
        ...
        stdout: JSON.stringify([
          {
            ...
            html_url: 'https://github.com/stablyai/manta/pull/5511',
      ...
      .mockResolvedValueOnce({
        stdout: JSON.stringify({
          ...
          title: 'Merged branch PR',
          state: 'MERGED',
          url: 'https://github.com/stablyai/manta/pull/5511',
          statusCheckRollup: [],
