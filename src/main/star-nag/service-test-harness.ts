...
export function resetStarNagMocks(mocks: StarNagMocks): void {
  ...
  mocks.checkMantaStarredMock.mockReset()
  mocks.checkMantaStarredMock.mockResolvedValue(false)
  mocks.starMantaMock.mockReset()
  mocks.starMantaMock.mockResolvedValue(true)
