...
const WSL_PATH_MISSING_OUTPUT = '__MANTA_WSL_PATH_MISSING__'
...
export function createCodexWslRuntimeHookInstallPlan(
  ...
  return {
    ...
    scriptPath: pathWin32.join(runtimeHomePath, '.manta', 'agent-hooks', 'codex-hook.sh'),
    commandScriptPath: pathPosix.join(linuxRuntimeHome, '.manta', 'agent-hooks', 'codex-hook.sh'),
