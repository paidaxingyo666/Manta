...
beforeEach(() => {
  tmpHome = mkdtempSync(join(tmpdir(), 'manta-codex-settings-upgrade-home-'))
  userDataDir = mkdtempSync(join(tmpdir(), 'manta-codex-settings-upgrade-data-'))
...
function baselinePath(): string {
  return join(runtimeHomePath(), '.manta-config-settings-baseline.json')
}
