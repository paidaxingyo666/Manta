 ...
 * app-server sessions when Manta's insertion shifts a user's hook positions, and
 ...
 */
const DISABLE_ENV_FLAG = 'MANTA_DISABLE_CODEX_TRUST_RPC'
...
/**
 * Grants trust for Manta's managed Codex hooks through codex's own app-server
