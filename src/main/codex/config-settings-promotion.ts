...
export type CodexSettingsBaselineSnapshotOptions = {
   ...
   * A bootstrap baseline must leave this false: claiming tables Manta never
...
function promoteCodexRuntimeSettingsToSystemUnsafe(
  ...
  // is legitimately empty before the first mirror — a table Manta never made
  ...
  // the canonical config with settings derived from Manta's runtime copy. One
