...
describe('AmpHookService', () => {
  ...
  beforeEach(() => {
    homeDir = mkdtempSync(join(tmpdir(), 'manta-amp-home-'))
  ...
  it('installs a Manta-managed Amp system plugin', () => {
    ...
    expect(source).toContain('process.env.MANTA_PANE_KEY')
  ...
  it('removes only Manta-managed Amp plugin files', () => {
