...
const linux = {
  resourcesPath: '/opt/Manta/resources',
...
const windows = {
  resourcesPath: 'C:\\Users\\me\\AppData\\Local\\Programs\\Manta\\resources',
  execPath: 'C:\\Users\\me\\AppData\\Local\\Programs\\Manta\\Manta.exe',
  get cliEntryPath(): string {
...
describe('CLI launch redirect: command form', () => {
  it('redirects a direct binary launch with no AppImage env at all', () => {
    expect(
      getCliLaunchArgs(
        ['/home/u/.config/manta-runtime/versions/1.4.158/manta-ide', 'skills', 'get', '--full'],
        linux.cliEntryPath,
        linuxOptions
      )
