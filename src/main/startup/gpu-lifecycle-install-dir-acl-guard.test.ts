 ...
 * Manta has no repair left to try. icacls must never be reached, so the runner throws.
 */
...
// that read. Asking "keep safe graphics?" on a machine Manta has just repaired invites a
