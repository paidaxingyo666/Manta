...
export async function presentGpuFallbackRecoveredLaunchPrompt(
  ...
  // Asking then would let a "keep it" answer pin software rendering on a machine Manta just fixed.
 ...
 * on a genuinely poisoned tree Manta has already told the user the admin commands, and the
