...
/**
 * PIDs of Manta's own Chromium processes — browser, renderers, GPU, utilities.
 *
 ...
 * kill in every field Manta records (#10680). A pid in this set is proof the
 ...
 * (main-process-preflight). The standalone daemon installs none and `mantad`
 ...
 * the *killing* process's own pid. Manta's Chromium processes are children of
 * Electron main, so they never classify `own` from a daemon or mantad host, and
