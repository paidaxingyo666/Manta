...
const cloud: MantaProfileCloudSummary = {
...
const capabilities: MantaCloudCapabilities = { flags: { share: true }, refreshedAt: 11 }
const organizations: MantaCloudOrgSummary[] = [{ orgId: 'org-1', name: 'Acme', role: 'Admin' }]

describe('Manta cloud sign-out vs newer connect', () => {
  beforeEach(() => {
  ...
  it('keeps a newer connect that finishes while sign-out is still revoking', async () => {
    ...
    revokeMantaCloudSessionMock.mockReturnValue(
