...
export type MantaSkillProviderId = SkillInstallProviderId

export type SkillProviderDestination = {
  provider: MantaSkillProviderId
  readsCanonicalRoot: boolean
  rootPath: string
}

export type SkillProviderRootOverrides = Partial<Record<MantaSkillProviderId, string>>
