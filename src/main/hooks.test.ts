...
describe('runHook', () => {
  ...
  it('runs Windows-path hooks through WSL when the project runtime targets WSL', async () => {
    ...
    try {
      ...
      const result = await runHook(
        'setup',
        'C:\\Users\\jinwo\\git\\manta-feature',
        {
          ...makeRepo(),
          path: 'C:\\Users\\jinwo\\git\\manta'
        },
      ...
      expect(execFileMock).toHaveBeenCalledWith(
        ...
        [
          ...
          'bash',
          '-c',
          "cd '/mnt/c/Users/jinwo/git/manta-feature' && echo hello"
        ],
        expect.any(Object),
        expect.any(Function)
      )
      expect(capturedOptions).toEqual(
        expect.objectContaining({
          env: expect.objectContaining({
            MANTA_ROOT_PATH: '/mnt/c/Users/jinwo/git/manta',
            MANTA_WORKTREE_PATH: '/mnt/c/Users/jinwo/git/manta-feature',
            CONDUCTOR_ROOT_PATH: '/mnt/c/Users/jinwo/git/manta',
            GHOSTX_ROOT_PATH: '/mnt/c/Users/jinwo/git/manta',
            ...
            WSLENV: expect.stringContaining(
              'MANTA_ROOT_PATH/u:MANTA_WORKTREE_PATH/u:CONDUCTOR_ROOT_PATH/u:GHOSTX_ROOT_PATH/u:MANTA_WORKSPACE_NAME/u'
            )
          })
        })
      )
  ...
  it('writes Windows-path setup runners through WSL git when the project runtime targets WSL', async () => {
    ...
    gitExecFileSyncMock.mockReturnValue('/mnt/c/Users/jinwo/git/manta/.git/manta/setup-runner.sh\n')
    ...
    try {
      ...
      expect(gitExecFileSyncMock).toHaveBeenCalledWith(
        ...
        {
          cwd: 'C:\\Users\\jinwo\\git\\manta-feature',
          wslDistro: 'Ubuntu'
        }
      )
