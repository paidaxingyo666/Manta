...
export const ISSUE_QUERY = `
  query MantaAgentLinearIssue($id: String!) {
    issue(id: $id) {
      ${ISSUE_FIELDS}
    }
  }
...
export const SEARCH_QUERY = `
  query MantaAgentLinearSearch($term: String!, $first: Int) {
...
export const COMMENTS_QUERY = `
  query MantaAgentLinearIssueComments($id: String!, $first: Int, $after: String) {
    issue(id: $id) {
...
export const CHILDREN_QUERY = `
  query MantaAgentLinearIssueChildren($id: String!, $first: Int, $after: String) {
    issue(id: $id) {
...
export const ATTACHMENTS_QUERY = `
  query MantaAgentLinearIssueAttachments($id: String!, $first: Int, $after: String) {
    issue(id: $id) {
...
export const RELATIONS_QUERY = `
  query MantaAgentLinearIssueRelations($id: String!, $first: Int, $after: String) {
    issue(id: $id) {
...
export const INVERSE_RELATIONS_QUERY = `
  query MantaAgentLinearIssueInverseRelations($id: String!, $first: Int, $after: String) {
    issue(id: $id) {
