...
describe('registerPtyHandlers', () => {
  ...
  it('strips runtime-owned SSH pane env when remote agent hooks are disabled', async () => {
    ...
    const savedRemoteHooks = process.env.MANTA_FEATURE_REMOTE_AGENT_HOOKS
    ...
    try {
      ...
      await spawnController.spawn({
        ...
        env: {
          FOO: 'bar',
          MANTA_PANE_KEY: makePaneKey('tab-remote', leafId),
          MANTA_TAB_ID: 'tab-remote',
          MANTA_WORKTREE_ID: 'wt-remote'
        },
      ...
      if (savedRemoteHooks === undefined) {
        ...
        process.env.MANTA_FEATURE_REMOTE_AGENT_HOOKS = savedRemoteHooks
      }
