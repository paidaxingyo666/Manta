...
async function previewBundleInstall(runtime: MantaRuntimeService, input: BundlePreviewInput) {
...
export function registerSkillInstallManagementIpcHandlers(runtime: MantaRuntimeService): void {
