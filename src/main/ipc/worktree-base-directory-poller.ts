...
export function createWorktreePollerWindowVisibility(
  ...
  // that has NEVER been shown is either headless (MANTA_E2E_HEADLESS keeps a live but
...
// churn to Manta just to observe a handful of shallow paths. The replacements
...
// Manta's own worktree operations notify the renderer directly.
