...
const MAIN_CHECKOUT = '/Users/dev/projects/manta'
const LINKED_WORKTREE = '/Users/dev/manta/workspaces/manta/pr-3235'
...
describe('repos:add with git worktrees', () => {
  ...
  it('matches the tracked main checkout across path separator differences', async () => {
    mockStore.getRepos.mockReturnValue([
      { ...trackedMainRepo(), path: 'C:\\Users\\dev\\projects\\manta' } as Repo
    ])
    getLinkedWorktreeMainRepoRootMock.mockReturnValue('C:/Users/dev/projects/manta')
