...
// user-initiated network path from the error-tracking lane to Manta infra. The per-bundle
...
export type CollectBundleOptions = {
  ...
  readonly mantaChannel: 'stable' | 'rc' | 'dev'
}
...
type BundleHeader = {
  ...
  readonly manta_channel: 'stable' | 'rc' | 'dev'
...
export function collectBundle(opts: CollectBundleOptions): CollectedBundle {
  ...
  const header: BundleHeader = {
    ...
    manta_channel: opts.mantaChannel,
