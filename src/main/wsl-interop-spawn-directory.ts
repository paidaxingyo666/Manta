 ...
 * `lpCurrentDirectory`, and NULL means *inherit the parent's*. Manta launched by
 * `manta-ide` from a WSL shell inherits `\\wsl.localhost\<distro>\...\<worktree>`
