  ...
  it('keeps the Windows omp ancestor when context selects one of multiple pi descendants', async () => {
    ...
    mockPs(
      windowsProcessJsonRows([
        ...
        {
          CommandLine: 'pi.exe --cwd C:\\repo\\manta',
          Name: 'pi.exe',
          ParentProcessId: 101,
          ProcessId: 102
        },
    ...
    await expect(
      resolveAgentForegroundProcess(100, 'pi.exe', { contextPaths: ['C:\\repo\\manta'] })
    ).resolves.toBe('omp')
  })
      ...
      (_cmd: string, _args: string[], _opts: unknown, cb: unknown) => {
        ...
        callback(null, {
          stdout: [
            ...
            'ProcessId=100',
            '',
            'CommandLine=node C:\\Users\\dev\\AppData\\Roaming\\npm\\node_modules\\@openai\\codex\\bin\\codex.js --cwd C:\\repo\\manta',
      ...
      (_cmd: string, _args: string[], _opts: unknown, cb: unknown) => {
        ...
        callback(null, {
          stdout: [
            ...
            'ProcessId=100',
            '',
            'CommandLine=codex --cwd C:\\repo\\manta',
            'CreationDate=20260616110100.000000-000',
            ...
            'ProcessId=101',
            '',
            'CommandLine=gemini --cwd C:\\repo\\manta',
            'CreationDate=20260616110200.000000-000',
            'ExecutablePath=C:\\Users\\dev\\AppData\\Roaming\\npm\\gemini.cmd',
            'Name=gemini.exe',
            'ParentProcessId=101',
