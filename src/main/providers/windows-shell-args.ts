...
export const MANTA_CODEX_LAUNCH_PREFLIGHT_CMD_QUOTE_ENV = 'MANTA_CODEX_LAUNCH_PREFLIGHT_CMD_QUOTE'
const CMD_CODEX_LAUNCH_PREFLIGHT = `if defined MANTA_CODEX_LAUNCH_PREFLIGHT call %${MANTA_CODEX_LAUNCH_PREFLIGHT_CMD_QUOTE_ENV}%%MANTA_CODEX_LAUNCH_PREFLIGHT%%${MANTA_CODEX_LAUNCH_PREFLIGHT_CMD_QUOTE_ENV}% agent hooks prepare-codex > nul 2>&1`
...
function buildWslShellArgs(linuxCwd: string, distro?: string): string[] {
  ...
  // login shell so terminal PATH matches the environment Manta detects.
