...
export type PtyProcessInfo = {
  ...
  worktreeId?: string
  /** Trusted MANTA_TERMINAL_HANDLE exported into this PTY, when known. */
  ...
  hostAgeMs?: number
  /** True when the host spawned this PTY for a Manta pane, false for a bare host shell. Absent from
