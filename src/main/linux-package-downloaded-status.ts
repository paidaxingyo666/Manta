...
export const LINUX_PACKAGE_EXTERNALLY_MANAGED_MESSAGE =
  'This copy of Manta is managed by your system package manager, so Manta cannot install updates itself. Update Manta through your distribution instead.'
export const LINUX_PACKAGE_MANUAL_INSTALL_MESSAGE =
  'Quit Manta before running the system package install command.'
