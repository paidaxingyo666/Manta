// Why a sidecar next to manta-data.json: scan snapshots rewrite wholesale and can reach hundreds
// of KB; folding them into manta-data.json would rewrite the whole state file per scan (the
