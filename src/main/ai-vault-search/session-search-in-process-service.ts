 ...
 * Neither of these hosts has that child: mantad ships only the watcher and daemon
 * entries beside `mantad.js`, and the relay's AI Vault sidecar runs the remote
