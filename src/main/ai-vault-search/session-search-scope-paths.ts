...
import { buildKnownMantaWorkspaceLayouts } from '../../shared/worktree/ownership'
...
/**
 * The directories Manta creates this repo's worktrees in, past and present, where
...
export function managedWorktreeDirectories(
  ...
  for (const layout of buildKnownMantaWorkspaceLayouts(settings, repo)) {
