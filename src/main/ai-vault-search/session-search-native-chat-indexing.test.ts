...
// Manta's own chat is the same file in the same place as one held in the
...
/** The rows Manta's native chat writes: uuid, block content, cwd on the first turn. */
