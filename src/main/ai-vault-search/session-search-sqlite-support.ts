 ...
 * neither exists on Node 18. That is not a hypothetical floor: mantad and the SSH
 * relay are both built for Node 18 and run on whatever the host has, and
 * build-mantad.mjs keeps that floor deliberately by excluding the only clusters
