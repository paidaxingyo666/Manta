...
const PLUGIN_KEY = 'manta-samples.demo'
const WORKTREE_ID = 'repo-id::/Users/private/manta'
...
function createServices(): PluginHostServices {
  return {
    resolveActiveWorktreeContext: vi.fn().mockResolvedValue({
      ...
      branch: 'main',
      displayName: 'Manta',
      path: '/Users/private/manta'
    }),
    listWorktreeTerminals: vi
      .fn()
      .mockResolvedValue([{ id: TERMINAL_ID, title: '/home/private/manta' }]),
