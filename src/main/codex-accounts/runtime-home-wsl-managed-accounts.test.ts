...
describe('CodexRuntimeHomeService', () => {
      ...
      createSettings({
        codexManagedAccounts: [
          ...
          },
          {
            ...
            managedHomeRuntime: 'wsl',
            wslDistro: 'Ubuntu',
            wslLinuxHomePath: '/home/alice/.local/share/manta/codex-accounts/account-2/home',
        ...
        codexManagedAccounts: [
          {
            ...
            managedHomeRuntime: 'wsl',
            wslDistro: 'Ubuntu',
            wslLinuxHomePath: '/home/alice/.local/share/manta/codex-accounts/wsl-account/home',
            providerAccountId: 'acct-wsl',
            workspaceLabel: null,
            workspaceAccountId: 'acct-wsl',
            createdAt: 1,
  ...
  it('launches and drains a mounted-drive WSL account through its distro path', async () => {
    ...
    const linuxHomePath = '/mnt/c/Users/alice/manta/codex-accounts/drive-account/home'
    vi.doMock('../wsl', () => ({
      getDefaultWslDistro: () => 'Ubuntu',
        ...
        codexManagedAccounts: [
          {
            ...
            managedHomePath: 'C:\\Users\\alice\\manta\\codex-accounts\\drive-account\\home',
            managedHomeRuntime: 'wsl',
            wslDistro: 'Ubuntu',
    ...
    try {
      ...
      expect(service.prepareForCodexLaunch({ runtime: 'wsl', wslDistro: 'Ubuntu' })).toBe(
        '\\\\wsl.localhost\\Ubuntu\\mnt\\c\\Users\\alice\\manta\\codex-accounts\\drive-account\\home'
      )
