 ...
 * turn-wide frame is `system/status`, whose payload is a bare token — every sentence Manta ever
 * put on this line for it was Manta's own wording for `requesting`, which is true for nearly the
