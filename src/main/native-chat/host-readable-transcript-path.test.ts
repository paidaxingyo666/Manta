...
const ROLLOUT_LINUX =
  '/home/ada/.local/share/manta/codex-runtime-home/home/sessions/2026/07/24/rollout-sess.jsonl'
const ROLLOUT_UNC =
  '\\\\wsl.localhost\\Ubuntu\\home\\ada\\.local\\share\\manta\\codex-runtime-home\\home\\sessions\\2026\\07\\24\\rollout-sess.jsonl'
...
describe('wslCodexSessionsDirs', () => {
  ...
  it('lists the managed and system Codex roots per distro home', async () => {
    await expect(
      ...
      `${UBUNTU_HOME}\\.local\\share\\manta\\codex-runtime-home\\home\\sessions`,
