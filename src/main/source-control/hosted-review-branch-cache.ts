 ...
 * and `manta serve` alike, and each one used to reach the provider directly. The
...
/**
 * Drops every cached answer for a repo. Called when Manta itself opens a review,
