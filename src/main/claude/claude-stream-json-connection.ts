...
export type ClaudeStreamJsonLaunch = {
  /** Manta's resolved user CLI; the SDK falls back to a bundled binary that is not installed. */
...
/**
 * Two questions with their own evidence. The root's verdict is first-hand: Manta's
