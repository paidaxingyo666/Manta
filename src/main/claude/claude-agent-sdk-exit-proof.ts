...
/**
 * Manta's own shutdown ladder on the child it spawned, kept because the SDK's
 * close path returns no proof and Manta never releases a lease on an assumed exit.
 *
