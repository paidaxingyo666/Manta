...
/**
 * What a message part that Manta cannot render says for itself. The kinds under
 ...
 */
export const CLAUDE_UNRENDERABLE_CONTENT_TEXT = 'Claude sent content Manta cannot display yet'
...
export function isModeledClaudeContent(value: unknown): boolean {
  ...
  if (part.type === 'image') {
    ...
    // A local attachment is replayed as the base64 (or file) source Manta itself
