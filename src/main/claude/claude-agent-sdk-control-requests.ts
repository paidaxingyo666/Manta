...
/**
 * Run one native Query control method under Manta's deadline and error classification.
 *
...
/** The native control surface Manta drives, one method per Query control request. */
