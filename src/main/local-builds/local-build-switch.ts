...
export async function chooseLocalBuild(
  ...
  const openDialogOptions: Electron.OpenDialogOptions = {
    title: 'Choose a Local Manta Build',
    buttonLabel: 'Choose Build',
    properties: ['openFile'],
    filters: [{ name: 'Manta update manifest', extensions: ['yml'] }]
  }
