...
export const RELAY_REMOTE_DIR = '.manta-remote'
...
export function isGitResponseStreamMarker(value: unknown): value is GitResponseStreamMarker {
  if (typeof value !== 'object' || value === null || !('__mantaGitResponseStream' in value)) {
    return false
  }
  const marker = (value as { __mantaGitResponseStream?: unknown }).__mantaGitResponseStream
