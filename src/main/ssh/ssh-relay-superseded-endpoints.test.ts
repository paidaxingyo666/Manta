...
const CURRENT_DIR = `${HOME}/.manta-remote/relay-0.1.0+bd3ec370d21d`
const OLD_SOCK = `${HOME}/.manta-remote/relay-0.1.0+7175e0a40ea7/${SOCK_NAME}`
...
describe('sweepSupersededRelayEndpoints', () => {
  ...
  it('keeps the endpoints it already classified when a later probe cannot confirm termination', async () => {
    const SECOND_SOCK = `${HOME}/.manta-remote/relay-0.1.0+cafebabe1234/${SOCK_NAME}`
