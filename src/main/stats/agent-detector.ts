 ...
 * manta-runtime.ts normalizeTerminalChunk but avoids importing the runtime.
 */
...
export class AgentDetector {
  ...
  /**
   * Called on every PTY data chunk (from manta-runtime.ts onPtyData).
  ...
  /**
   * Called when a PTY process exits (from manta-runtime.ts onPtyExit).
   */
