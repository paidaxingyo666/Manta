...
export function mapGhosttyToManta(
  ...
  const FIELD_PARSERS: Record<string, FieldParser> = {
    ...
    'focus-follows-mouse': (v) => {
      // Why: Ghostty's focus-follows-mouse is semantically identical to Manta's
  ...
  for (const [key, rawValue] of Object.entries(parsed)) {
    ...
    // Why: Manta's windowBackgroundBlur is a boolean; the numeric radius is lost.
