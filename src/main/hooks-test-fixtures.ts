...
export const TEST_REPO_MANTA_YAML_PATH = join(TEST_REPO_PATH, 'manta.yaml')
export const TEST_WORKTREE_MANTA_YAML_PATH = join(TEST_WORKTREE_PATH, 'manta.yaml')
export const TEST_ISSUE_COMMAND_PATH = join(TEST_REPO_PATH, '.manta', 'issue-command')
