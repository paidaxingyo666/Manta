...
export const MANTA_PI_EXTENSION_FILE = 'manta-titlebar-spinner.ts'
...
export function getPiTitlebarExtensionSource(kind: PiAgentKind = 'pi'): string {
  ...
  return [
    ...
    '',
    '// Why: `-` is the plain separator; `!` is the state marker Manta reads as needs-input',
    ...
    ...(kind === 'pi'
      ? [
          ...
          '  // one process may assert it. Mirrors MANTA_PI_STATUS_OWNED in the status hook.',
