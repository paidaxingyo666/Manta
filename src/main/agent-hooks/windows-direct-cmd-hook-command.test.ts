...
const SAFE_PATH = 'C:\\Users\\alice\\.manta\\agent-hooks\\claude-hook.cmd'
...
describe('wrapWindowsDirectCmdHookCommand', () => {
  it('emits the script path with forward slashes and a neutral-JSON fallback', () => {
    expect(wrapWindowsDirectCmdHookCommand(SAFE_PATH)).toBe(
      'C:/Users/alice/.manta/agent-hooks/claude-hook.cmd || echo {}'
    )
  })
  ...
  it('declines any path the shells cannot carry bare', () => {
    for (const path of [
      'C:\\Users\\Bob Smith\\.manta\\agent-hooks\\claude-hook.cmd',
      'C:\\Users\\%name%\\.manta\\agent-hooks\\claude-hook.cmd',
      'C:\\Users\\a^b\\.manta\\agent-hooks\\claude-hook.cmd',
      'C:\\Users\\a&b\\.manta\\agent-hooks\\claude-hook.cmd',
      'C:\\Users\\a(b)\\.manta\\agent-hooks\\claude-hook.cmd',
      'C:\\Users\\rené\\.manta\\agent-hooks\\claude-hook.cmd',
      '/home/alice/.manta/agent-hooks/claude-hook.sh',
      ...
      '\\\\server\\share\\alice\\.manta\\agent-hooks\\claude-hook.cmd'
    ]) {
