...
// Manta's script, but the presence gate below then skips install() forever, freezing the
// script at whatever Manta generated last. Existing scripts are Manta-owned, so bring them
