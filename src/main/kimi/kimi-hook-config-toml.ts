...
const BLOCK_START = '# >>> manta-managed-kimi-hooks (managed by Manta; do not edit) >>>'
const BLOCK_END = '# <<< manta-managed-kimi-hooks <<<'
...
// Manta-managed script (by filename, so a moved userData path is still swept).
