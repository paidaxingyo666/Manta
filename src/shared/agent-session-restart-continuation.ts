// The one message Manta sends when a user asks an interrupted agent to carry on.
//
...
export const AGENT_SESSION_RESTART_CONTINUATION_MESSAGE =
  "Manta restarted, so your previous reply was cut off partway through. Before continuing, check whether your most recent action completed — don't repeat it if it did. Then carry on."

/**
 * Host-authored journal note marking the send as Manta's rather than the user's.
 *
