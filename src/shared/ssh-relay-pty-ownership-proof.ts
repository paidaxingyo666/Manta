 ...
 *  (`docs/reference/ssh-execution-boundary.md`): a second machine running the same Manta build
...
export type RelayPtyOwnershipEvidence = {
   ...
   *  from `agentSessionOwners`: that one asks whether Manta REGISTERED an agent session here, this
