...
export function createMobileRelayPairingFixtures(now: number): PairingFixture[] {
  ...
  return [
    ...
    },
    {
      ...
      payload: { ...directOffer, relay: { ...relay, directorUrl: 'https://relay.manta.sh.cn/' } },
      expected: null
    },
    {
      name: 'non-HTTPS cell origin is invalid',
      payload: { ...directOffer, relay: { ...relay, cellUrl: 'http://relay-c1.manta.sh.cn' } },
      expected: null
    },
    {
