...
function sanitizeTuiAgentLaunchArgs(agent: TuiAgent, args: string): string {
  ...
  // skip-permission flags on the interactive TUI command Manta launches.
 ...
 *
 * Resolved, not configured: an untouched Arguments field falls back to the default Manta ships,
