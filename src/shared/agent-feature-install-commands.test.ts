...
describe('agent feature skill commands', () => {
  ...
  it('exports single-skill update constants without changing install bundles', () => {
    expect(MANTA_CLI_SKILL_UPDATE_COMMAND).toBe('npx skills update orca-cli --global')
    ...
    expect(MANTA_LINEAR_SKILL_UPDATE_COMMAND).toBe('npx skills update orca-linear --global')
