...
export const SOURCE_CONTROL_ACTION_VARIABLE_INFO = {
  basePrompt: {
    description:
      'Manta’s built-in prompt for this action, including the context Manta knows how to gather safely.',
    example:
  ...
  firstPrompt: {
    description: 'The first user request that created the Manta workspace.',
    example: 'Fix CI and commit the result'
  },
  assistantMessage: {
    description: 'The initial agent response, when Manta has one available.',
