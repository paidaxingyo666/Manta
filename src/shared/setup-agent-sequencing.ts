...
export const SETUP_AGENT_SEQUENCE_STARTUP_COMMAND_ENV = 'MANTA_SEQUENCED_STARTUP_COMMAND'
export const SETUP_AGENT_SEQUENCE_STARTUP_SCRIPT_ENV = 'MANTA_SEQUENCED_STARTUP_SCRIPT'
...
function buildWindowsSetupCommand(
  ...
  const script = [
    ...
    '$processInfo.Arguments = \'/d /s /v:on /c ""!MANTA_SETUP_RUNNER!""\'',
    '$processInfo.UseShellExecute = $false',
    '$processInfo.EnvironmentVariables["MANTA_SETUP_RUNNER"] = $runner',
...
function buildWindowsStartupCommand(
  ...
  const script = [
    ...
    'try { Set-ExecutionPolicy -Scope Process -ExecutionPolicy Bypass -Force -ErrorAction Stop } ' +
      'catch { [Console]::Error.WriteLine("Manta: could not relax the execution policy for this " + ' +
