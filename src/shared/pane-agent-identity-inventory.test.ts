...
const INVENTORY: readonly InventoryGroup[] = [
  ...
  },
  {
    ...
    classification: 'evidence-producer',
    paths: [
      ['src/main/runtime/manta-runtime-apply-tracked-pty-title.ts', 2],
      ['src/main/runtime/manta-runtime-get-pty-record-for-pane-key.ts', 2],
      ['src/main/runtime/manta-runtime-get-unpersisted-tracked-title-for-pty.ts', 2],
      ['src/main/runtime/manta-runtime-maybe-hydrate-headless-from-renderer.ts', 2],
      ['src/main/runtime/manta-runtime-record-agent-prompt-lifecycle-state.ts', 2],
  ...
  },
  {
    ...
    paths: [
      ...
      ['src/main/runtime/manta-runtime-write-orchestration-pointer-pty.ts', 2]
    ]
  }
]
