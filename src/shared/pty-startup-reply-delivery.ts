...
// discipline sits between Manta and the querying program can echo it straight back out as
...
//
// The reply is written IMMEDIATELY, in the caller's turn. Manta used to withhold it until
