...
// Agents whose sessions Manta can remove completely: everything the session
...
// why (a provider's storage layout is Manta's problem, not the reader's):
...
// - codex: session_index.jsonl plus hardlink aliases between the Manta-managed
