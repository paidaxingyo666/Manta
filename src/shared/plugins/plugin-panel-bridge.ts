...
export const PANEL_ACTION_REQUEST_TYPE = 'manta-panel-action'
export const PANEL_ACTION_RESULT_TYPE = 'manta-panel-action-result'
export const PANEL_PING_TYPE = 'manta-panel-ping'
export const PANEL_PONG_TYPE = 'manta-panel-pong'
export const PLUGIN_PANEL_FRAME_NAME_PREFIX = 'manta-plugin-panel:'
