...
describe('parseAgentStatusPayload', () => {
  ...
  it('compacts Manta dispatch preambles so the task body survives 200-char truncation', () => {
...
Fix dispatch fallback preview for normalized status prompts`
    ...
    expect(result!.prompt.startsWith('You are working inside Manta, a multi-agent IDE.')).toBe(true)
