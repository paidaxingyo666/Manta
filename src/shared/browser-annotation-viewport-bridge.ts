...
export const BROWSER_ANNOTATION_VIEWPORT_MESSAGE_PREFIX = '__manta_annotation_viewport__:'
...
export function buildBrowserAnnotationViewportBridgeScript({
  ...
  const stateKey = '__mantaBrowserAnnotationViewportBridge';
  const hostAttribute = 'data-manta-browser-annotation-overlay';
  const markerSize = 24;
