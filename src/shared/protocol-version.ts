...
// Why: declares the Manta runtime RPC compatibility contract. Desktop,
...
export const JIRA_USER_FIELDS_UPDATE_REQUIRED_MESSAGE =
  'Creating Jira issues with user fields requires a newer Manta server. Update the server and try again.'
...
// the hook was found — an SSH host whose manta.yaml cannot be read answers "no hook" and the removal
...
export const FILE_MUTATION_OWNERSHIP_UPDATE_REQUIRED_MESSAGE =
  'Remote file changes require a newer Manta server. Update the HUB and try again.'
...
export const GITHUB_MARK_PR_READY_UPDATE_REQUIRED_MESSAGE =
  'Marking a pull request ready requires a newer Manta server. Update the server and try again.'
...
export const GITLAB_READY_FOR_REVIEW_UPDATE_REQUIRED_MESSAGE =
  'Marking a merge request ready requires a newer Manta server. Update the server and try again.'
...
export const RUNTIME_CAPABILITIES = [
  ...
  AUTOMATION_OWNER_FENCING_RUNTIME_CAPABILITY,
  AUTOMATION_CREATE_IDEMPOTENCY_RUNTIME_CAPABILITY,
  // Self-hosted relay owns push; this upstream capability is not advertised.
  AGENT_LAUNCH_RUNTIME_CAPABILITY,
