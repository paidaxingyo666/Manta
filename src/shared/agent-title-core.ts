...
// a closed set (the native literal plus the labels Manta synthesizes from Cursor hooks),
...
// Manta's hook-synthesized spinner state, but only once a Cursor-owned title already
