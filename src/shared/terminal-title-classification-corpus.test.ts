...
const PINNED_CLASSIFICATIONS: readonly PinnedRow[] = [
  ...
  ['nwparker@mac: ~/manta', null, null, false, false, null, false, null, null],
  ...
  ['\u03c0 > session - ~/manta', 'idle', 'Pi', false, false, 'Pi', false, 'pi', 'pi'],
  ['\u03c0 ! blocked-session', 'permission', 'Pi', false, false, 'Pi', false, 'pi', 'pi'],
  ['\u280b \u03c0 - session - ~/manta', 'working', 'Pi', true, false, 'Pi', true, 'pi', 'pi'],
