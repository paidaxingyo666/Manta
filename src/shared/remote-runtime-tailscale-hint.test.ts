...
const UNREACHABLE = 'Could not connect to the remote Manta runtime.'
...
describe('isTailscaleEndpoint', () => {
  ...
  it('rejects non-Tailscale hosts and the surrounding 100.x space', () => {
    ...
    expect(isTailscaleEndpoint('wss://manta.example.com')).toBe(false)
...
describe('withRemoteRuntimeTailscaleHint', () => {
  ...
  it('leaves non-connectivity errors untouched', () => {
    const auth = 'Remote Manta runtime rejected the pairing token.'
