...
describe('skills CLI agent keys', () => {
  ...
  it('covers every agent Manta can detect', () => {
  ...
  it("follows Manta's own evidence for the two non-obvious mappings", () => {
    ...
    // Why: Manta detects trae via `traecli`, which tui-agent-config calls an alias
