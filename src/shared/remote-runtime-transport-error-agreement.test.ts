...
const REQUEST_TRANSPORT_ERRORS: TransportErrorPair[] = [
  ...
  },
  {
    ...
    message: 'Timed out waiting for the remote Manta runtime to respond.'
  },
  {
  ...
  },
  {
    ...
    message: 'Could not connect to the remote Manta runtime.'
  },
  {
    producer: 'remote-runtime-client.ts:270 / :667 (formatRemoteRuntimeCloseMessage, 1006)',
    code: 'remote_runtime_unavailable',
    message: 'Remote Manta runtime closed the connection.'
  },
  {
    producer: 'remote-runtime-client.ts:270 / :667 (formatRemoteRuntimeCloseMessage, 1011)',
    code: 'remote_runtime_unavailable',
    message: `Remote Manta runtime closed the connection (1011: ${CLOSE_REASON.toString()}).`
  },
  {
    producer: 'remote-runtime-client.ts:289',
    code: 'invalid_runtime_response',
    message: 'Remote Manta runtime returned an unexpected binary frame.'
  },
  {
    producer: 'remote-runtime-client.ts:310 / :693',
    code: 'invalid_runtime_response',
    message: 'Remote Manta runtime returned an undecryptable frame.'
  },
  {
  ...
  },
  {
    ...
    code: 'remote_runtime_unavailable',
    message: 'Remote Manta runtime request was released before it could be sent.'
  },
  {
    producer: 'remote-runtime-client.ts:459 / :829',
    code: 'invalid_runtime_response',
    message: 'Remote Manta runtime returned a mismatched response id.'
  },
  {
  ...
  },
  {
    ...
    code: 'runtime_timeout',
    message: 'Timed out waiting for the remote Manta runtime subscription to start.'
  },
  {
    producer: 'remote-runtime-client.ts:587',
    code: 'remote_runtime_unavailable',
    message: 'Remote Manta runtime send buffer overflow; reconnecting.'
  },
  {
    producer: 'remote-runtime-client.ts:735',
    code: 'remote_runtime_unavailable',
    message: 'Remote Manta runtime stopped responding; the stream connection was reset.'
  },
  {
    producer: 'remote-runtime-client.ts:842',
    code: 'invalid_runtime_response',
    message: 'Remote Manta runtime returned binary data before authentication.'
  },
  {
    producer: 'remote-runtime-client.ts:852',
    code: 'invalid_runtime_response',
    message: 'Remote Manta runtime returned an undecryptable binary frame.'
  },
  {
  ...
  producedPair(
    ...
    invalidRemoteRuntimeResponseError('Remote Manta runtime returned an invalid E2EE auth frame.')
  ),
  producedPair(
...
const SHARED_CONTROL_TRANSPORT_ERRORS: TransportErrorPair[] = [
  ...
  producedPair(
    ...
    remoteRuntimeUnavailableError(
      'Remote Manta runtime stopped responding; resetting the control connection.'
    )
  ),
  producedPair(
...
const HOST_FORWARDED_TRANSPORT_ERRORS: TransportErrorPair[] = [
  ...
  },
  {
    producer: 'main/runtime/rpc/errors.ts:145 (STRUCTURED_RUNTIME_PASSTHROUGH_CODES)',
    code: 'invalid_runtime_response',
    message: 'Remote Manta runtime returned an invalid response frame.'
  },
  {
    producer: 'main/runtime/rpc/errors.ts:145 (STRUCTURED_RUNTIME_PASSTHROUGH_CODES)',
...
const TAILSCALE_HINTED_TRANSPORT_ERRORS: TransportErrorPair[] = [
  ...
  },
  {
    ...
    code: 'remote_runtime_unavailable',
    message: withRemoteRuntimeTailscaleHint(
      'Remote Manta runtime closed the connection.',
...
const CODELESS_TRANSPORT_ERRORS: (TransportErrorPair & { recoverable: boolean })[] = [
  {
    ...
    message: 'Remote Manta runtime is not connected.',
    recoverable: true
  },
  {
    producer: 'web-runtime-client.ts:359 / :360 / :591',
    message: 'Remote Manta runtime connection closed.',
    recoverable: true
  },
  {
