...
export type SshTarget = {
  id: string
  label: string
  /** Internal owner for targets that Manta creates as implementation details.
...
export type SshConfigHostSummary = {
  ...
  proxyCommand?: string
  jumpHost?: string
  /** True when a Manta SSH target already uses this config alias. */
  alreadyInManta: boolean
  /**
   * True when the user deleted this alias from Manta (tombstone). Still listed so they
