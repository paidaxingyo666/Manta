...
describe('tab title resolution', () => {
  ...
  it('keeps OpenCode native and Manta-generated title behavior intact', () => {
    const aiVaultTitle = {
      ...
      resolveTerminalTabTitle(
        {
          customTitle: null,
          aiVaultTitle,
          generatedTitle: 'Manta generated',
    ...
    expect(
      resolveTerminalTabTitle(
        { customTitle: null, generatedTitle: 'Manta generated', title: '⠋ albacore' },
        true
      )
    ).toBe('Manta generated')
  })
