...
export const ORCHESTRATION_COMPATIBILITY_HOST_KIND_ENV =
  'MANTA_ORCHESTRATION_COMPATIBILITY_HOST_KIND'
export const ORCHESTRATION_COMPATIBILITY_HOST_ID_ENV = 'MANTA_ORCHESTRATION_COMPATIBILITY_HOST_ID'
export const ORCHESTRATION_COMPATIBILITY_HOST_INCARNATION_ENV =
  'MANTA_ORCHESTRATION_COMPATIBILITY_HOST_INCARNATION'
export const ORCHESTRATION_COMPATIBILITY_ATTACHMENT_ENV =
  'MANTA_ORCHESTRATION_COMPATIBILITY_ATTACHMENT'
...
export function readOrchestrationCompatibilityEvidence(
  ...
  const terminalHandle = boundedValue(env.MANTA_TERMINAL_HANDLE)
  const paneKey = boundedValue(env.MANTA_PANE_KEY)
  const launchToken = boundedValue(env.MANTA_AGENT_LAUNCH_TOKEN)
