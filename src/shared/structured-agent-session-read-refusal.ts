 ...
 * is never a transcript Manta could not read — it is a session this host has not attached YET (the
 ...
 *
 * The genuinely latched lease — "Manta cannot prove the previous owner exited" — reaches the client
