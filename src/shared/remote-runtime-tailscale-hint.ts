...
const REMOTE_RUNTIME_UNREACHABLE_RE =
  /could not connect to the remote manta runtime|remote manta runtime closed the connection|timed out (?:waiting for|while connecting to) the remote manta runtime/i
