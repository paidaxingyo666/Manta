...
// Why: a headed Manta server keeps answering status.get after its workspace window
...
// window exists (manta-runtime.ts:4806), so pairing it with a non-ready graph is the
