...
describe('release channel', () => {
  ...
  it('finds the directly runnable installer for a platform', () => {
    ...
    expect(findInstallerAssetName('win32', assets)).toBe('manta-windows-setup.exe')
    expect(findInstallerAssetName('darwin', assets)).toBe('manta-macos-arm64.dmg')
    expect(findInstallerAssetName('linux', assets)).toBe('manta-linux.AppImage')
