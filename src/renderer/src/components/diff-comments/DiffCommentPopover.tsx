...
export function DiffCommentPopover({
  ...
  return (
    <div
      ref={popoverRef}
      className="manta-diff-comment-popover"
    ...
    >
      {/* Content */}
      <div className="manta-diff-comment-content-col" style={{ gap: '8px' }}>
        <div id={labelId} className="manta-diff-comment-popover-label">
          {title ??
