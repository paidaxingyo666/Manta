...
export default function MobilePage(): React.JSX.Element {
  ...
  const signedIn = useAppStore((state) => state.mantaProfileAuthStatus?.state === 'connected')
  const refreshAuthStatus = useAppStore((state) => state.fetchMantaProfileAuthStatus)
