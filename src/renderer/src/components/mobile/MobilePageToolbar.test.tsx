...
describe('MobilePageToolbar', () => {
  it('labels the sidebar toggle explicitly when Manta Mobile is visible in the sidebar', () => {
    ...
    expect(html).not.toContain('Remove Manta Mobile')
  })

  it('labels the restore action explicitly when Manta Mobile is hidden from the sidebar', () => {
    const html = renderToStaticMarkup(
      <MobilePageToolbar
