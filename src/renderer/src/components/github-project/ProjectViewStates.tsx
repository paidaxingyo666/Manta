        ...
        <div className="space-y-2">
          <p className="text-xs leading-5 text-muted-foreground">
            ...
            {translate(
              ...
              'Switch to a Table or Roadmap view to work with this project in Manta.'
            )}
          </p>
          <Button
            type="button"
      ...
      : error.type === 'unsupported_layout'
        ? // Why: an older paired host still reports roadmaps as unsupported, so this
          ...
          translate(
            ...
            'Manta renders table and roadmap project views. This view uses a layout it cannot render yet.'
          )
