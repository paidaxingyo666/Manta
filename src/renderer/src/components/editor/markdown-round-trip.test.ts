...
describe('rich markdown round trip', () => {
  ...
  it('preserves inline math in a details summary across an edit', () => {
    ...
    ).toBe('<details class="manta-details">\n<summary>Switch $x^2$</summary>\n\nBody\n\n</details>')
  })
  ...
  it('preserves heading-styled details blocks', () => {
    expect(
      roundTripMarkdown(
        '<details data-manta-toggle="heading-1"><summary>Toggle</summary><p>Body</p></details>\n'
      )
    ).toBe(
      '<details class="manta-details" data-manta-toggle="heading-1">\n<summary>Toggle</summary>\n\nBody\n\n</details>'
    )
  })
  ...
  it.each(['heading-2', 'heading-3', 'heading-4', 'heading-5'])(
    ...
    (variant) => {
      expect(
        roundTripMarkdown(
          `<details data-manta-toggle="${variant}"><summary>Toggle</summary><p>Body</p></details>\n`
        )
      ).toBe(
        `<details class="manta-details" data-manta-toggle="${variant}">\n<summary>Toggle</summary>\n\nBody\n\n</details>`
      )
    }
  )
  ...
  it('preserves a heading toggle when its attribute uses HTML whitespace around equals', () => {
    expect(
      roundTripMarkdown(
        '<details data-manta-toggle = "heading-4"><summary>Toggle</summary><p>Body</p></details>\n'
      )
    ).toBe(
      '<details class="manta-details" data-manta-toggle="heading-4">\n<summary>Toggle</summary>\n\nBody\n\n</details>'
    )
  })
  ...
  it('preserves details blocks with unsupported toggle variants as passthrough html', () => {
    const input =
      '<details data-manta-toggle="heading-6"><summary>Toggle</summary><p>Body</p></details>\n'
    expect(roundTripMarkdown(input)).toBe(input.trimEnd())
  })
  ...
  it('inserts editable heading toggles from slash commands', () => {
    expect(slashCommandMarkdown('toggle-h1')).toBe(
      '<details class="manta-details" data-manta-toggle="heading-1" open>\n<summary></summary>\n\n\n\n</details>'
    )
  ...
  it.each([
    ...
    expect(slashCommandMarkdown(commandId)).toBe(
      `<details class="manta-details" data-manta-toggle="${variant}" open>\n<summary></summary>\n\n\n\n</details>`
    )
