...
function dispatchLoadFailure(
  ...
  Object.assign(event, {
    ...
    validatedURL: 'https://share.manta.sh.cn/a/report',
...
describe('ArtifactPreview', () => {
  beforeEach(() => {
    Object.assign(window, {
      api: {
        browser: { sessionResolvePartition: vi.fn().mockResolvedValue('persist:manta-default') }
      }
    })
  })
  ...
  it('ignores child-frame failures and aborted navigations', async () => {
    render(<ArtifactPreview shareUrl="https://share.manta.sh.cn/a/report" />)
