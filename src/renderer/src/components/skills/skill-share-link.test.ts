...
describe('parseSkillShareId', () => {
  it('accepts durable Manta links and bare identifiers', () => {
    ...
    expect(parseSkillShareId('https://app.manta.dev/skills/share/share_123')).toBe('share_123')
  ...
  it('rejects attacker origins and lookalike paths', () => {
    ...
    expect(parseSkillShareId('https://app.manta.dev/skills/share/share_123/more')).toBeNull()
