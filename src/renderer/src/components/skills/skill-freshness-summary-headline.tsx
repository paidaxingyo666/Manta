    ...
    return (
      <div className="flex items-center gap-2 text-xs text-muted-foreground">
        ...
        {translate(
          ...
          'Checking installed Manta skills…'
        )}
      </div>
    )
  }
    ...
    return (
      <p className="text-xs text-muted-foreground">
        {translate(
          ...
          'No installed Manta skills found.'
        )}
      </p>
    )
  }
    ...
    return (
      <div className="flex items-center gap-2 text-sm font-medium text-foreground">
        ...
        {translate(
          ...
          'All installed Manta skills are up to date.'
        )}
      </div>
    )
  }
    ...
    return (
      <div className="flex items-center gap-2 text-sm font-medium text-foreground">
        ...
        {translate(
          ...
          'Some installed Manta skills were left out of the update.'
        )}
      </div>
    )
  }
