...
export function useTaskPageLinearFilterSelection(model: TaskPageLinearListSelectionPreludeModel) {
  ...
  const nextModel = model as typeof model & {
    ...
    inMantaLinkedLinearRefs: typeof inMantaLinkedLinearRefs
    inMantaLinkedLinearRefsSignature: typeof inMantaLinkedLinearRefsSignature
    inMantaLinkedLinearRefsRef: typeof inMantaLinkedLinearRefsRef
  }
  ...
  nextModel.inMantaLinkedLinearRefs = inMantaLinkedLinearRefs
  nextModel.inMantaLinkedLinearRefsSignature = inMantaLinkedLinearRefsSignature
  nextModel.inMantaLinkedLinearRefsRef = inMantaLinkedLinearRefsRef
  return nextModel
}
