...
describe('connectPanePty', () => {
  ...
  it('clears pre-hook launch config when a Manta-started command exits', async () => {
  ...
  it('confirms a Manta-launched Droid fresh spawn in a no-OSC shell (Git Bash)', async () => {
