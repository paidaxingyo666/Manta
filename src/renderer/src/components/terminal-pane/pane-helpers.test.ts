...
describe('shellEscapePath', () => {
  ...
  it('keeps safe Windows paths unquoted', () => {
    expect(shellEscapePath('C:\\Users\\manta\\file.txt', 'windows')).toBe(
      'C:\\Users\\manta\\file.txt'
    )
  })

  it('double-quotes Windows paths with spaces', () => {
    expect(shellEscapePath('C:\\Users\\manta\\my file.txt', 'windows')).toBe(
      '"C:\\Users\\manta\\my file.txt"'
    )
  })

  it('double-quotes Windows paths with cmd separators', () => {
    expect(shellEscapePath('C:\\Users\\manta\\a&b.txt', 'windows')).toBe(
      '"C:\\Users\\manta\\a&b.txt"'
    )
  })
  ...
  it('uses POSIX escaping for SSH drops regardless of client OS', () => {
    ...
    expect(shellEscapePath("/home/u/wt/.manta/drops/my file's $draft.txt", 'posix')).toBe(
      "'/home/u/wt/.manta/drops/my file'\\''s $draft.txt'"
    )
  })
})
