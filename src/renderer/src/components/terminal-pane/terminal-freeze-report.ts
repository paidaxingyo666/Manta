// One-paste freeze report: `await window.__mantaTerminalFreezeReport()` in the
...
type TerminalFreezeReportWindow = Window & {
  __mantaTerminalFreezeReport?: () => Promise<TerminalFreezeReport>
}
...
export function installTerminalFreezeReport(): void {
  ...
  ;(window as TerminalFreezeReportWindow).__mantaTerminalFreezeReport = buildTerminalFreezeReport
}
