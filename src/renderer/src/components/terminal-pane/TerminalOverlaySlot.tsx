...
const HAS_CSS_ANCHOR_POSITIONING =
  ...
  CSS.supports('position-anchor', '--manta-terminal-overlay-probe') &&
  CSS.supports('top', 'anchor(--manta-terminal-overlay-probe top)') &&
  CSS.supports('width', 'anchor-size(--manta-terminal-overlay-probe width)')
