      ...
      <DialogContent className="gap-4 sm:max-w-[620px]">
        <DialogHeader>
          ...
          <DialogDescription className="sr-only">
            {translate(
              ...
              'Install the Manta CLI and orchestration skill so agents can coordinate through Manta.'
            )}
          </DialogDescription>
        </DialogHeader>
        ...
        <AgentSkillSetupPanel
          ...
          description={translate(
            ...
            'Enables agents to hand off context and coordinate work through Manta.'
          )}
