      ...
      <SelectedTextCopyMenu className="space-y-3">
        ...
        <WorktreeCardIssueDetailSection
          ...
          onOpenGitHubIssueInManta={
            secondary.handleOpenGitHubIssueInManta
              ? dismissAndRun(secondary.handleOpenGitHubIssueInManta)
              : undefined
          }
        ...
        {secondary.hoverLinearIssue && (
          <WorktreeCardDetailSection>
            <DetailHeader
              ...
              actions={
                <>
                  {secondary.hoverLinearIssue.url && secondary.handleOpenLinearIssueInManta && (
                    <MetadataActionIcon
                      label={translate(
                        'auto.components.sidebar.WorktreeCardMeta.2c67730e07',
                        'Open in Manta'
                      )}
                      onClick={dismissAndRun(secondary.handleOpenLinearIssueInManta)}
                    >
        ...
        <WorktreeCardReviewDetailSection
          ...
          onOpenReviewInManta={secondary.handleOpenReviewInManta}
