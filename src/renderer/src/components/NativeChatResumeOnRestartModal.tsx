        ...
        <div className="space-y-2 p-3">
          ...
          <p className="text-xs text-muted-foreground">
            {translate(
              ...
              'Continuing sends one short message to each agent, telling it that Manta restarted and asking it to check its last action before carrying on. Your own prompt is never re-sent.'
            )}
          </p>
          ...
          <DialogDescription>
            {interruptedByUpdate
              ? translate(
                  ...
                  'These chats were mid-turn when Manta installed an update. Reconnecting restores each one where it stopped, with its full context and without re-sending your prompt — the interrupted reply will not continue on its own.'
                )
              : translate(
                  'auto.components.NativeChatResumeOnRestartModal.body',
                  'These chats were mid-turn when Manta closed. Reconnecting restores each one where it stopped, with its full context and without re-sending your prompt — the interrupted reply will not continue on its own.'
                )}
          </DialogDescription>
          ...
          <span className="min-w-0 space-y-0.5">
            ...
            <span className="block text-xs text-muted-foreground">
              {translate(
                ...
                'Qualifying chats will be reconnected automatically after a restart, and Manta will tell you when it happens. You can turn this off in Settings → Experimental → Chat UI.'
              )}
            </span>
          </span>
        </label>
