              ...
              <div className="min-w-0 shrink space-y-0.5">
                ...
                <p className="text-xs text-muted-foreground">
                  {translate(
                    ...
                    'Local sessions only for now. WSL and remote execution hosts (including SSH) continue to use terminal chat, and Windows falls back to it unless Manta can read process start times.'
                  )}
                </p>
              </div>
              <SettingsSwitch
              ...
              <div className="min-w-0 shrink space-y-0.5">
                ...
                <p className="text-xs text-muted-foreground">
                  {translate(
                    ...
                    'When Manta quits or installs an update, chats that were mid-turn are offered again on the next launch. On, they are reconnected without asking and Manta tells you afterwards — the same thing as ticking "Don\'t ask again" in that prompt. Off, you choose from the list each time. Reconnecting restores a chat where it stopped; it does not continue the interrupted reply.'
                  )}
                </p>
              </div>
              <SettingsSwitch
