...
export const getNotificationsPaneSearchEntries = createLocalizedCatalog(() => [
  {
    ...
    description: translate(
      ...
      'Master switch for Manta desktop notifications.'
    ),
    keywords: [
  ...
  },
  {
    ...
    description: translate(
      ...
      'Avoid notifying when Manta is focused on the active worktree.'
    ),
    keywords: [
      ...translateSearchKeyword(
        'auto.components.settings.notifications.search.ca8faa40d7',
  ...
  },
  {
    ...
    description: translate(
      ...
      'Choose the built-in, system, or local audio file Manta plays for desktop notifications.'
    ),
    keywords: [
      ...translateSearchKeyword(
        'auto.components.settings.notifications.search.ca8faa40d7',
