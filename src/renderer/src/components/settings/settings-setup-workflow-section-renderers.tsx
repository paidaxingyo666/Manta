...
export function renderMantaAccountSettingsSection(
  ...
  return model.showDesktopOnlySettings ? (
    <SettingsSection
      ...
      searchEntries={navigation.getSectionSearchEntries('manta-account')}
    >
      {view.isSectionMounted('manta-account') ? <MantaAccountSettingsPane /> : null}
    </SettingsSection>
  ) : null
}
  ...
  return (
    <SettingsSection
      ...
      description={translate(
        ...
        'Search everything your agents have said and done, on this computer and on any paired Manta server.'
      )}
