...
export function getActiveServerModeDescription(allowLocalRuntime: boolean): string {
  return allowLocalRuntime
    ...
    : translate(
        ...
        'Selecting a saved server makes this browser use that paired Manta runtime as its default Host.'
      )
}
          ...
          <div className="min-w-0 space-y-0.5">
            ...
            <p className="text-xs text-muted-foreground">
              {translate(
                ...
                'Pair another Manta runtime, then connect or disconnect it here.'
              )}
            </p>
          </div>
          ...
          <div className="space-y-0.5">
            ...
            <p className="text-xs text-muted-foreground">
              {translate(
                ...
                'Create access links for browsers, mobile clients, or another Manta client to connect back to this running app.'
              )}
            </p>
          </div>
              ...
              <div className="min-w-0 space-y-0.5">
                <div className="text-sm font-medium">
                  {translate(
                    ...
                    'Share this Manta server'
                  )}
                </div>
                <p className="text-xs text-muted-foreground">
                  {translate(
                    'auto.components.settings.RuntimeEnvironmentsPane.84b9b2be05',
                    'Create a revocable access grant so a browser or another Manta client can connect.'
                  )}
                </p>
              </div>
              <Button
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              {translate(
                ...
                'Manta will focus this host and load its projects. Existing terminals and browser tabs on other hosts stay alive.'
              )}
            </DialogDescription>
          </DialogHeader>
          {pendingSwitchValue ? (
            ...
            <DialogDescription>
              {removingActiveServer
                ...
                : translate(
                    ...
                    'This removes the saved server from Manta. It does not change the active server.'
                  )}
            </DialogDescription>
          </DialogHeader>
          {pendingRemove ? (
