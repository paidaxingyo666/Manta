...
import type { MantaHooks, RepoHookSettings } from '../../../../shared/manta-yaml-hook-types'
...
export function RepositoryPane({
  ...
  const handleCopyTemplate = async () => {
    // Why: the missing-`manta.yaml` state is a migration aid, so copying the shared-template
        ...
        <div className="flex items-start justify-between gap-4">
          ...
          <SearchableSetting
            ...
            description={translate(
              ...
              'Remove this project from Manta on all configured hosts.'
            )}
