    ...
    try {
      accepted = await confirm({
        ...
        description: translate(
          ...
          'Manta will build a local search index on this computer. It copies conversation text and tool output from agent transcripts as written; content is not redacted. Indexing starts now, runs in the background, and the first scan can take several minutes. You can turn it off at any time; progress is kept.'
        ),
      ...
      const accepted = await confirm({
        ...
        description: policy.enabled
          ? translate(
              ...
              'Remove the search index from this computer. Original transcripts are not touched. Search is on, so Manta scans them again from scratch afterward.'
            )
          : translate(
        ...
        description={
          isWebClient
            ? translate(
                ...
                'Manage indexing in the Manta desktop app on the computer that owns the transcripts. These controls are unavailable from a paired client.'
              )
            : translate(
