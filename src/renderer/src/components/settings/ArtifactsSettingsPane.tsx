...
export function ArtifactsSettingsPane({
  ...
  const howToSteps: HowToStep[] = [
      ...
      : [
          {
            ...
            description: isWebClient
              ? translate(
                  ...
                  'Open Settings → Artifacts in the Manta desktop app on the host device and enable publishing.'
                )
              : translate(
    ...
    {
      key: 'manage',
      title: translate('auto.components.settings.artifacts.manageStepTitle', 'Manage it in Manta'),
      description: translate(
