...
export function BrowserUseSetup({
  ...
  const browserUseInstallCommand = !activeSkillRuntime.installDisabledReason
    ? buildSkillCommandForRuntime(MANTA_CLI_SKILL_INSTALL_COMMAND, activeSkillRuntime.agentRuntime)
    : MANTA_CLI_SKILL_INSTALL_COMMAND
  const browserUseUpdateCommand = !activeSkillRuntime.installDisabledReason
    ? buildSkillCommandForRuntime(MANTA_CLI_SKILL_UPDATE_COMMAND, activeSkillRuntime.agentRuntime)
    : MANTA_CLI_SKILL_UPDATE_COMMAND
  ...
  const cliEnabled = isMantaCliAvailableOnPath(cliStatus)
