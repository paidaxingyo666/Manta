 ...
 * updates replace the bundle), Accessibility/Automation grants on Manta silently stop
        ...
        <div className="min-w-0 space-y-1">
          ...
          <p className="text-xs leading-snug">
            {translate(
              ...
              'The terminal daemon was started by a Manta install that no longer exists, so macOS can’t attribute its commands to Manta — Accessibility and Automation grants are silently ignored (osascript fails with error -25211). Restarting the daemon fixes this; running terminal sessions will close.'
            )}
          </p>
        </div>
      </div>
