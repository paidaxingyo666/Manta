...
import { MANTA_LINEAR_SKILL_NAME } from '@/lib/agent-feature-install-commands'
  ...
  return (
    <SearchableSetting
      ...
      description={translate(
        ...
        'How Linear works in Manta: browse issues, start linked workspaces, and let agents update tickets with /manta-linear.'
      )}
    ...
    >
      ...
      <SkillUsageExamplesSection
        ...
        slashCommand={`/${MANTA_LINEAR_SKILL_NAME}`}
      />
