        ...
        <AppearanceAdvancedDisclosure showTopBorder={false}>
          <div className="divide-y divide-border/40">
            <SearchableSetting
              ...
              keywords={titlebarEntry?.keywords ?? ['titlebar', 'manta', 'app', 'name']}
            >
              <SettingsSwitchRow
                label={translate(
                  'auto.components.settings.AppearancePane.9868f39007',
            ...
            {isDesktopWindows ? (
              ...
              >
                <SettingsSwitchRow
                  ...
                  // Why: platform constraint + "close keeps Manta running" consequence are
                  // both non-obvious from the label alone.
                  description={translate(
                    'auto.components.settings.AppearancePane.b707773a0d',
                    'When enabled, closing the window keeps Manta running in the system tray instead of quitting.'
                  )}
              ...
              >
                <SettingsSwitchRow
                  ...
                  description={translate(
                    ...
                    'Keep a Manta shortcut and activity indicator in the macOS menu bar.'
                  )}
