...
function Settings(): React.JSX.Element {
  ...
  const [repoHooksMap, setRepoHooksMap] = useState<
    Record<string, { hasHooks: boolean; hooks: MantaHooks | null; mayNeedUpdate: boolean }>
  >({})
  ...
  useEffect(() => {
    ...
    } else if (settingsNavigationTarget.intent === 'add-remote-manta-server') {
  ...
  useEffect(() => {
    ...
    setRepoHooksMap((previous) => {
      ...
      ) as Record<string, { hasHooks: boolean; hooks: MantaHooks | null; mayNeedUpdate: boolean }>
              ...
              <ActiveSettingsSectionProvider value={activeSectionId}>
                ...
                {showDesktopOnlySettings ? (
                  <SettingsSection
                    id="manta-account"
                    title={translate(
                      'auto.components.settings.mantaAccount.title',
                      'Manta Account'
                    )}
                    description={translate(
                    ...
                    searchEntries={getSectionSearchEntries('manta-account')}
                  >
                    {isSectionMounted('manta-account') ? <MantaAccountSettingsPane /> : null}
                  </SettingsSection>
                ) : null}
                ...
                <SettingsSection
                  ...
                  description={translate(
                    ...
                    'Finish the core workflows that make Manta useful for parallel agent work.'
                  )}
                ...
                {showDesktopOnlySettings ? (
                  <SettingsSection
                    ...
                    description={translate(
                      ...
                      'Configure mobile emulator support for Manta and coding agents.'
                    )}
                ...
                <SettingsSection
                  ...
                  description={translate(
                    ...
                    'Manta stats plus Claude, Codex, OpenCode token analytics and Grok subscription usage.'
                  )}
                  ...
                  description={
                    isWebClient
                      ? translate(
                          ...
                          'Connect this browser to a saved Manta server.'
                        )
                      : translate(
                          'auto.components.settings.Settings.b5ee17826b',
                          'Pair remote Manta runtimes for persistent sessions, richer remote state, and web or mobile handoff.'
                        )
                  }
