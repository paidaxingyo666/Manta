...
function getInstallDescription(platform: string): string {
  if (platform === 'darwin') {
    return 'Register `manta` in /usr/local/bin.'
  }
  if (platform === 'linux') {
    return 'Register `manta-ide` in ~/.local/bin.'
  }
  if (platform === 'win32') {
    return 'Register `manta` in your user PATH.'
  }
    ...
    <section className="space-y-4" data-settings-section="cli">
      <div className="space-y-1">
        <h2 className="text-sm font-semibold">
          {translate('auto.components.settings.CliSection.c5c0f2641d', 'Manta CLI')}
        </h2>
          ...
          <div className="border-t border-border/60 pt-3">
            <div className="space-y-0.5">
              ...
              <p className="text-xs text-muted-foreground">
                {translate(
                  ...
                  'Give agents Manta-aware workspace, terminal, and progress workflows.'
                )}
              </p>
            </div>
            ...
            <AgentSkillSetupPanel
              ...
              description={translate(
                ...
                'Enables agents to use Manta workspace, terminal, and progress commands.'
              )}
