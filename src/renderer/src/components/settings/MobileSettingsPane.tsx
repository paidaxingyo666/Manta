...
const MANTA_ANDROID_APK_URL =
  'https://github.com/paidaxingyo666/Manta/releases/download/mobile-android-v0.0.43/app-release.apk'
    ...
    <div className="space-y-4">
        ...
        <div className="space-y-2 text-xs text-muted-foreground">
          <p>
            {translate(
              ...
              'Install Manta Mobile from the'
            )}{' '}
            <button
              type="button"
              onClick={() => void window.api.shell.openUrl(MANTA_IOS_APP_STORE_URL)}
            ...
            <button
              ...
              onClick={() => void window.api.shell.openUrl(MANTA_ANDROID_APK_URL)}
              className="cursor-pointer underline underline-offset-2 hover:text-foreground"
            >
              {translate(
      ...
      <SearchableSetting
        title={translate(
          ...
          'Show Manta Mobile Button'
        )}
        description={translate(
          'auto.components.settings.MobileSettingsPane.682293cadf',
          'Show the Manta Mobile button at the top of the left sidebar.'
        )}
      ...
      >
        ...
        <SettingsSwitchRow
          ...
          description={translate(
            ...
            'Show the Manta Mobile shortcut in the sidebar.'
          )}
