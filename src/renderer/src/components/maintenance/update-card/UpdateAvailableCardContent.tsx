...
/** A package manager owns this install: the release is real but Manta can never apply it here. */
function ExternallyManagedNote(): React.JSX.Element {
  return (
    <p className="text-xs leading-relaxed text-muted-foreground">
      {translate(
        'auto.components.UpdateCard.7f1a4c9e02',
        'Your system package manager installed Manta, so update it from there — Manta cannot install this release itself.'
      )}
    </p>
  )
}
