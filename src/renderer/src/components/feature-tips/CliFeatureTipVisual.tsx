...
const CLI_AGENT_COMMANDS = [
  'manta worktree create --name auth-pr-1',
  'manta worktree create --name auth-pr-2',
  'manta orchestration dispatch --task pr1 --to w1',
  'manta orchestration dispatch --task pr2 --to w2'
]
