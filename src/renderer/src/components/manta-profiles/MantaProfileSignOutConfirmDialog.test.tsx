...
import { MantaProfileSignOutConfirmDialog } from './MantaProfileSignOutConfirmDialog'
...
describe('MantaProfileSignOutConfirmDialog', () => {
  it('describes account sign-out without presenting a local profile or warning', () => {
    ...
    expect(html).toContain('Sign out of Manta?')
