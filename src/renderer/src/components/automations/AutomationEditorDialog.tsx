...
export type AutomationCreateTarget = 'manta' | 'hermes'
...
type AutomationEditorDialogProps = {
  ...
  /** Present only while creating a Manta automation. */
  createDestination?: AutomationCreateDestinationControl
  /** Present only while editing a Manta automation; selecting another host moves the record. */
