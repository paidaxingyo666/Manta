...
type WorktreeCardIssueDetailSectionProps = {
  ...
  onOpenGitHubIssueInManta?: (event: React.MouseEvent) => void
}
      ...
      <DetailHeader
        ...
        actions={
          <>
                ...
                <DropdownMenuContent align="end" className="w-40">
                  {onOpenIssueInBrowser && (
                    ...
                    >
                      ...
                      {translate(
                        'auto.components.sidebar.WorktreeCardMeta.openInMantaBrowser',
                        'Open in Manta browser'
                      )}
                    </DropdownMenuItem>
                  )}
                  {onCopyIssueLink && (
            ...
            {issue.url && onOpenGitHubIssueInManta && (
              <MetadataActionIcon
                label={translate(
                  'auto.components.sidebar.WorktreeCardMeta.2c67730e07',
                  'Open in Manta'
                )}
                onClick={onOpenGitHubIssueInManta}
              >
