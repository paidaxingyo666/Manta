  ...
  if (forceDeleteReason) {
    ...
    if (forceDeleteReason === 'running-agent-session') {
      return {
        ...
        // Why this is not the "could not confirm" wording: Manta watched these sessions stay
        ...
        description: translate(
          ...
          'This workspace still has running agent sessions, so Manta stopped before deleting any files. Force Delete will close them and discard any work they hold.'
        ),
        isDestructive: false
      }
    }
