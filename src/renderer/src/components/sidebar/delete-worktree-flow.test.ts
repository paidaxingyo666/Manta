...
describe('delete worktree flow', () => {
  ...
  it('opens project removal confirmation for a primary workspace', () => {
    ...
    mocks.state.repos = [{ id: 'repo-1', displayName: 'manta' }]
  ...
  it('routes primary workspace removal to its exact SSH host', () => {
    ...
    mocks.state.repos = [
      { id: 'repo-1', displayName: 'local manta' },
      { id: 'repo-1', displayName: 'provisioned manta', connectionId: 'runtime-ssh-one' }
    ]
