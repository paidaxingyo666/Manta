...
vi.mock('@/hooks/useVirtualizedScrollAnchor', () => ({
  VIRTUALIZED_SCROLL_ANCHOR_RECORD_EVENT: 'manta:test-record-scroll-anchor',
...
vi.mock('./WorktreeCardAgents', () => ({
  ...
  SUPPRESS_WORKTREE_LIST_SCROLL_ADJUSTMENT_EVENT: 'manta:test-suppress-scroll-adjustment'
}))

vi.mock('./WorktreeContextMenu', () => ({
  default: ({ children }: { children: ReactNode }) => <>{children}</>,
  CLOSE_ALL_CONTEXT_MENUS_EVENT: 'manta:test-close-context-menus',
  WORKTREE_CONTEXT_MENU_SCOPE_ATTR: 'data-manta-context-menu-scope',
...
function makeHostedReview(overrides: Partial<HostedReviewInfo> = {}): HostedReviewInfo {
  return {
    ...
    state: 'open',
    url: 'https://gitlab.com/acme/manta/-/merge_requests/42',
    status: 'success',
