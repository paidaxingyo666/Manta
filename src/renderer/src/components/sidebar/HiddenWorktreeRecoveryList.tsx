...
export default function HiddenWorktreeRecoveryList({
  ...
  const filtered = normalizedQuery
    ...
    : hidden
  const discoveredCount = hidden.length + getVisibleNonMantaWorktrees(detected).length
              ...
              {normalizedQuery
                ...
                : discoveredCount > 0
                  ...
                  : translate(
                      ...
                      'New worktrees will appear here when Manta detects them.'
                    )}
            </div>
          </div>
        </div>
