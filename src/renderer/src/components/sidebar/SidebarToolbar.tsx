...
const WORKSPACE_BOARD_MOVED_HINT_STORAGE_KEY = 'manta.workspaceBoardMovedHintSeen.v1'
...
const SidebarToolbar = React.memo(function SidebarToolbar({
  ...
  // translate() preserves Manta's pseudo-localization behavior. Without it the
