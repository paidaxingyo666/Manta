...
const sections: SettingsNavSection[] = [
  {
    ...
    searchEntries: [
      {
        title: 'Manta CLI',
        description: 'Register or remove the manta shell command.',
  ...
  },
  {
    ...
    description: 'Pair remote Manta runtimes.',
    icon: Settings,
    searchEntries: [{ title: 'Remote Manta Servers' }],
    group: 'remote'
  },
  {
    id: 'ssh',
...
describe('Cmd+J palette middle-band ranking', () => {
  it.each([
    ...
    ['manta cli', 'settings:general:cli'],
    ...
    const integrationSections: SettingsNavSection[] = [
      {
        id: 'linear',
        title: 'Linear',
        description: 'How Linear works in Manta.',
        icon: Settings,
        searchEntries: [],
        group: 'capabilities'
      },
