import type { TaskPageLinearInMantaEffectsModel } from './use-task-page-linear-in-manta-effects'
...
export type TaskPageLinearCollectionEffectsPreludeModel = TaskPageLinearInMantaEffectsModel
export function useTaskPageLinearCollectionEffectsPrelude(model: TaskPageLinearInMantaEffectsModel) {
  const {
    setTaskResumeState,
...
export function useTaskPageLinearCollectionEffects(model: TaskPageLinearInMantaEffectsModel) {
