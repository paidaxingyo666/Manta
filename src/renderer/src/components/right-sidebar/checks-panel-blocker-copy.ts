...
> = {
  ...
  fork_head_unsupported: {
    ...
    body: {
      ...
      fallback: 'Manta cannot create a {{reviewLabel}} from this fork head here.'
    }
  },
  base_not_on_remote: {
    title: {
  ...
  unsupported_provider: {
    ...
    body: {
      ...
      fallback: 'This repository provider does not support creating a {{reviewLabel}} from Manta.'
    }
  }
}
  ...
  if (reason === 'existing_review') {
    ...
    return {
      ...
      description: translate(
        ...
        'Manta found an existing {{reviewLabel}} for this branch.',
        { reviewLabel }
      ),
      composerMode: 'hidden',
      workflowAction: null,
...
> = {
  ...
  auth_required: {
    ...
    body: {
      ...
      fallback:
        '{{provider}} must be connected in this environment before Manta can create a {{reviewLabel}}.'
    },
    workflow: null
  }
}
