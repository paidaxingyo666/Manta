...
describe('ChecksPanelReviewHeader', () => {
  it('opens the PR from the number and puts link management behind the menu', () => {
    ...
    expect(markup).toContain(
      'Manta will hide PR #2964 details for this workspace. The PR and branch on GitHub won’t be changed.'
    )
  ...
  it('shows GitLab MR identity with provider-appropriate link management actions', () => {
    ...
    expect(markup).toContain(
      'Manta will hide MR !31 details for this workspace. The MR and branch on GitLab won’t be changed.'
    )
