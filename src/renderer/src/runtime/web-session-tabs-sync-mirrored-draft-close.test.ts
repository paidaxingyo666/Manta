...
import { MANTA_EDITOR_REQUEST_FILE_CLOSE_EVENT } from '@/components/editor/editor-autosave'
...
describe('tab-strip close of a client-dirty mirrored file after a host republish (#21392)', () => {
  ...
  beforeEach(() => {
    ...
    window.addEventListener(MANTA_EDITOR_REQUEST_FILE_CLOSE_EVENT, onCloseRequest)
  ...
  afterEach(() => {
    window.removeEventListener(MANTA_EDITOR_REQUEST_FILE_CLOSE_EVENT, onCloseRequest)
