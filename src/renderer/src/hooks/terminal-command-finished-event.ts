export const MANTA_TERMINAL_COMMAND_FINISHED_EVENT = 'manta:terminal-command-finished'
...
export function dispatchTerminalCommandFinishedEvent(
  ...
  window.dispatchEvent(
    new CustomEvent<TerminalCommandFinishedEventDetail>(MANTA_TERMINAL_COMMAND_FINISHED_EVENT, {
