...
export const TOGGLE_TERMINAL_PANE_EXPAND_EVENT = 'manta-toggle-terminal-pane-expand'
export const FOCUS_TERMINAL_PANE_EVENT = 'manta-focus-terminal-pane'
export const PASTE_TERMINAL_TEXT_EVENT = 'manta-paste-terminal-text'
export const SPLIT_TERMINAL_PANE_EVENT = 'manta-split-terminal-pane'
export const REQUEST_ACTIVE_TERMINAL_PANE_SPLIT_EVENT = 'manta-request-active-terminal-pane-split'
export const CLOSE_TERMINAL_PANE_EVENT = 'manta-close-terminal-pane'
export const BACKGROUND_MOUNT_TERMINAL_WORKTREE_EVENT = 'manta-background-mount-terminal-worktree'
...
export const WAKE_HIBERNATED_AGENTS_WORKTREE_EVENT = 'manta-wake-hibernated-agents-worktree'
...
export const SYNC_FIT_PANES_EVENT = 'manta-sync-fit-panes'
