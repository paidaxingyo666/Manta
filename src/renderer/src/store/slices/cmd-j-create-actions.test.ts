...
vi.mock('@/lib/web-client-location', () => ({
  isWebClientLocation: () =>
    Boolean((globalThis as { __MANTA_WEB_CLIENT__?: boolean }).__MANTA_WEB_CLIENT__)
}))

const pairedWebFlag = globalThis as { __MANTA_WEB_CLIENT__?: boolean }
