...
export const mantaProfileFindProjectProfiles: Mock = vi.fn()
...
export function installReposRuntimeRoutingHarness(): void {
  beforeEach(() => {
    ...
    ptyKill.mockReset()
    mantaProfileFindProjectProfiles.mockReset()
    ...
    vi.stubGlobal('window', {
      api: {
        ...
        mantaProfiles: {
          findProjectProfiles: mantaProfileFindProjectProfiles
        },
        pty: { kill: ptyKill },
