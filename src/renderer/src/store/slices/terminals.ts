...
export type TerminalSlice = {
  ...
  /** True only after hydrateWorkspaceSession loaded real manta-data.json; guards the session writer so an early-startup crash can't overwrite good data on disk. */
