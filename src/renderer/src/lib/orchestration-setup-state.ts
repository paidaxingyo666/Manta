export const ORCHESTRATION_SETUP_STATE_EVENT = 'manta:orchestration-setup-state'
export const ORCHESTRATION_ENABLED_STORAGE_KEY = 'manta.orchestration.enabled'
export const ORCHESTRATION_SETUP_DISMISSED_STORAGE_KEY = 'manta.orchestration.setupDismissed'
