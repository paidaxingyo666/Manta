...
describe('isWorkItemLookupText', () => {
  it('detects GitHub PR and issue URLs', () => {
    expect(isWorkItemLookupText('https://github.com/stablyai/manta/pull/4900')).toBe(true)
    expect(isWorkItemLookupText('https://github.com/stablyai/manta/issues/123')).toBe(true)
    expect(isWorkItemLookupText('  https://www.github.com/stablyai/manta/pull/1 ')).toBe(true)
  })
