...
export const CMD_J_FIXTURE_PORTS: ReadonlyMap<string, { port: number; processName?: string }[]> =
  new Map([
    ['wt-main-manta', [{ port: 3000, processName: 'node' }]],
...
export const CMD_J_FIXTURE_CASES: readonly CmdJFixtureCase[] = [
  ...
  { query: 'main 3000', expected: ['wt-main-manta'] },
  { query: 'acme/manta main', expected: ['wt-main-manta'] },
  { query: 'manta/main', expected: ['wt-main-manta'] },
