...
describe('markdown document templates', () => {
  ...
  it('discovers markdown files under .manta/templates and skips unsafe entries', async () => {
    const readDir = stubReadDir({
      '/repo/.manta/templates': [
        entry('daily-note.md'),
        entry('scratch.txt'),
      ...
      '/repo/.manta/templates/nested': [entry('meeting.markdown'), entry('brief.mdx')]
    })
    ...
    await expect(
      ...
      {
        id: '.manta/templates/nested/brief.mdx',
        name: 'Brief',
        filePath: '/repo/.manta/templates/nested/brief.mdx',
        relativePath: '.manta/templates/nested/brief.mdx',
        templateRelativePath: 'nested/brief.mdx',
        basename: 'brief.mdx'
      },
      {
        id: '.manta/templates/daily-note.md',
        name: 'Daily note',
        filePath: '/repo/.manta/templates/daily-note.md',
        relativePath: '.manta/templates/daily-note.md',
        templateRelativePath: 'daily-note.md',
        basename: 'daily-note.md'
      },
      {
        id: '.manta/templates/nested/meeting.markdown',
        name: 'Meeting',
        filePath: '/repo/.manta/templates/nested/meeting.markdown',
        relativePath: '.manta/templates/nested/meeting.markdown',
  ...
  it('keeps Windows file paths native while exposing root-relative template paths', async () => {
    stubReadDir({
      'C:\\repo\\.manta\\templates': [entry('daily.md')]
    })
    ...
    await expect(
      ...
      {
        id: '.manta/templates/daily.md',
        name: 'Daily',
        filePath: 'C:\\repo\\.manta\\templates\\daily.md',
        relativePath: '.manta/templates/daily.md',
