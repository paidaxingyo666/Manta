...
describe('splitPathHeadForElision', () => {
  ...
  it('extends the tail back to the first matched segment and re-bases ranges', () => {
    const path = '/Users/me/projects/manta/new-create-button-design/proposals/create-button.html'
