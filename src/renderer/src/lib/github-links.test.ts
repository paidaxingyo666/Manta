...
describe('buildGitHubRepoUrl', () => {
  ...
  it('encodes path segments', () => {
    expect(buildGitHubRepoUrl({ owner: 'stably ai', repo: 'manta/tools' })).toBe(
      'https://github.com/stably%20ai/manta%2Ftools'
    )
  })

  it('links hosted slugs to their GitHub Enterprise server', () => {
    expect(buildGitHubRepoUrl({ owner: 'team', repo: 'manta', host: 'github.acme-corp.com' })).toBe(
      'https://github.acme-corp.com/team/manta'
    )
  })
})
