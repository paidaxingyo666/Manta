...
type ReferenceWidgetConstructor = {
  prototype: ReferenceWidgetInstance & {
    __mantaPeekPreviewOptionsInstalled?: true
  }
}

function applyPeekReferencesPreviewOptions(editor: PeekPreviewEditor | undefined): void {
  // Why: Monaco embedded editors inherit Manta's full-editor options first.
...
export function installMonacoPeekReferencesPreviewOptions(
  ...
  if (prototype.__mantaPeekPreviewOptionsInstalled) {
    return
  }
  ...
  prototype.__mantaPeekPreviewOptionsInstalled = true
}
