...
// Why: when a repo has no `manta.yaml` issueCommand and no per-user override,
...
function getDefaultTabCommandPreview(yamlHooks: MantaHooks | null): string {
 ...
 * their `manta.yaml` / `.manta/issue-command` yet.
 */
