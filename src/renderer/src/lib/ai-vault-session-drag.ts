...
export const AI_VAULT_SESSION_DRAG_TYPE = 'application/x-manta-ai-vault-session'
export const AI_VAULT_SESSION_DRAG_START_EVENT = 'manta-ai-vault-session-drag-start'
export const AI_VAULT_SESSION_DRAG_END_EVENT = 'manta-ai-vault-session-drag-end'
...
export function writeAiVaultSessionDragData(
  ...
  // resume command instead of letting Manta's pane drop layer handle it.
