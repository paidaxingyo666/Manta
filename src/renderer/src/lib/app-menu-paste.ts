...
export const APP_MENU_PASTE_EVENT = 'manta-app-menu-paste'
...
export async function handleAppMenuPasteRequest({
  ...
  try {
    ...
    // control gained focus, not the text control Manta already resolved.
  ...
  // Why: for text controls Manta has already resolved ownership. Falling back
