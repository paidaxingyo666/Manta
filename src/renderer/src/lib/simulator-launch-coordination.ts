...
export const EMULATOR_MANUAL_LAUNCH_STARTED_EVENT = 'manta:emulator-launch-started'
export const EMULATOR_MANUAL_LAUNCH_FAILED_EVENT = 'manta:emulator-launch-failed'
