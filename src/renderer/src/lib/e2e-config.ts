...
export const e2eDisableRemoteTerminalStallRecovery =
  ...
  rendererE2EQuery?.get('mantaE2EDisableRemoteTerminalStallRecovery') === '1'
const rendererFallbackE2EConfig = createE2EConfig({
  exposeStore: rendererE2EExposeStore,
  terminalParkingDelayMs: Number(rendererE2EQuery?.get('mantaE2ETerminalParkingDelayMs')) || null,
  terminalRetentionLimit: Number(rendererE2EQuery?.get('mantaE2ETerminalRetentionLimit')) || null
})
