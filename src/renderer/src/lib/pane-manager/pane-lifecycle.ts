...
export function openTerminal(
  ...
  // Activate Manta's Unicode 11 width shim *before* any caller-driven write. CJK / emoji /
  ...
  // Deferred attachment restores Manta's DA1 handler after the addon registers its own.
  if (inlineImages) {
