...
export type CodexPaneScanResult = {
  ...
  /** Manta launched Codex in this tab, so a shell foreground can still be reattach settle. */
 ...
 * Gated to Manta-launched Codex panes so an account switch never spends the
 ...
 * baked into their environment. Without this, quitting Manta before restarting a
