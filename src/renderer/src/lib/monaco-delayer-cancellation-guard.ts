...
type GuardedDelayerPrototype = MonacoDelayerInstance & {
  __mantaDelayerCancellationGuardInstalled?: true
}
...
export function installMonacoDelayerCancellationGuard(): void {
  ...
  if (delayerPrototype.__mantaDelayerCancellationGuardInstalled) {
    return
  }
  ...
  delayerPrototype.__mantaDelayerCancellationGuardInstalled = true
}
