  ...
  it('routes every runtime-backed GitHub method through the expected RPC method', async () => {
    ...
    const routeCases: {
      ...
      },
      {
        ...
        args: { repoPath, owner: 'acme', repo: 'manta', number: 7, type: 'pr' },
      ...
      },
      {
        ...
        args: { owner: 'acme', repo: 'manta', number: 7, type: 'issue' },
        expectedMethod: 'github.project.workItemDetailsBySlug',
        expectedParams: { owner: 'acme', repo: 'manta', number: 7, type: 'issue' }
      },
      {
      ...
      },
      {
        ...
        args: { owner: 'acme', repo: 'manta', number: 7, updates: { title: 'New' } },
        expectedMethod: 'github.project.updateIssueBySlug',
        expectedParams: { owner: 'acme', repo: 'manta', number: 7, updates: { title: 'New' } }
      },
      {
      ...
      },
      {
        ...
        args: { owner: 'acme', repo: 'manta', number: 7, body: 'Fixed' },
        expectedMethod: 'github.project.addIssueCommentBySlug',
        expectedParams: { owner: 'acme', repo: 'manta', number: 7, body: 'Fixed' }
      },
      {
        key: 'updateIssueCommentBySlug',
        args: { owner: 'acme', repo: 'manta', commentId: 9, body: 'Edited' },
        expectedMethod: 'github.project.updateIssueCommentBySlug',
        expectedParams: { owner: 'acme', repo: 'manta', commentId: 9, body: 'Edited' }
      },
      {
        key: 'deleteIssueCommentBySlug',
        args: { owner: 'acme', repo: 'manta', commentId: 9 },
        expectedMethod: 'github.project.deleteIssueCommentBySlug',
        expectedParams: { owner: 'acme', repo: 'manta', commentId: 9 }
      },
      {
        key: 'listLabelsBySlug',
        args: { owner: 'acme', repo: 'manta' },
        expectedMethod: 'github.project.listLabelsBySlug',
        expectedParams: { owner: 'acme', repo: 'manta' }
      },
      {
        key: 'listAssignableUsersBySlug',
        args: { owner: 'acme', repo: 'manta', seedLogins: ['alice'] },
        expectedMethod: 'github.project.listAssignableUsersBySlug',
        expectedParams: { owner: 'acme', repo: 'manta', seedLogins: ['alice'] }
      },
      {
      ...
      },
      {
        ...
        args: { owner: 'acme', repo: 'manta', number: 7, issueTypeId: 'it-1' },
        expectedMethod: 'github.project.updateIssueTypeBySlug',
        expectedParams: { owner: 'acme', repo: 'manta', number: 7, issueTypeId: 'it-1' }
      }
    ]
