...
export function useAppSessionPersistence(): void {
  ...
  useEffect(() => {
    ...
    window.addEventListener(MANTA_APP_RESTART_ABORTED_EVENT, shutdownCheckpoint.abandonAttempt)
    window.addEventListener(
      MANTA_UPDATER_QUIT_AND_INSTALL_ABORTED_EVENT,
    ...
    return () => {
      ...
      window.removeEventListener(MANTA_APP_RESTART_ABORTED_EVENT, shutdownCheckpoint.abandonAttempt)
      window.removeEventListener(
        MANTA_UPDATER_QUIT_AND_INSTALL_ABORTED_EVENT,
        shutdownCheckpoint.abandonAttempt
      )
