...
export const CORE_COMMAND_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    usage: 'manta worktree rm --worktree <selector> [--force] [--run-hooks] [--json]',
  ...
  },
  {
    ...
    usage: 'manta terminal close [--terminal <handle>] [--tab] [--json]',
    ...
    examples: [
      'manta terminal close --terminal term_abc123',
      'manta terminal close --terminal term_abc123 --tab --json'
    ]
  },
  {
