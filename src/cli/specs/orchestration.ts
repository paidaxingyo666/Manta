...
export const ORCHESTRATION_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    usage:
      'manta orchestration run-create --objective <text> [--from <handle>] [--retry-request <id>] [--json]',
  ...
  },
  {
    ...
    usage:
      'manta orchestration run-use --id <run_id> [--from <handle>] [--takeover-legacy] [--retry-request <id>] [--json]',
  ...
  },
  {
    ...
    usage:
      'manta orchestration send --subject <text> [--to <run:id|dispatch:id|legacy_handle>] [--run <run_id>] [--from <handle>] [--body <text>] [--type <type>] [--priority <level>] [--thread-id <id>] [--payload <json>] [--task-id <id>] [--dispatch-id <id>] [--outcome <succeeded|failed>] [--files-modified <csv>] [--report-path <path>] [--phase <text>] [--retry-request <id>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'to',
      'run',
    ...
    notes: [
      ...
      'Use --to dispatch:<id> for attempt-specific coordinator guidance; Manta durably relays it to a connected worker server.',
  ...
  },
  {
    ...
    usage:
      'manta orchestration check [--terminal <handle>] [--run <run_id>] [--ack <delivery_id>] [--unread | --peek | --all] [--types <type,...>] [--format] [--wait] [--timeout-ms <n>] [--retry-request <id>] [--json]\n' +
  ...
  },
  {
    ...
    usage:
      'manta orchestration reply --id <msg_id> --body <text> [--run <run_id>] [--from <handle>] [--retry-request <id>] [--json]',
  ...
  },
  {
    ...
    usage: 'manta orchestration inbox [--limit <n>] [--terminal <handle>] [--full] [--json]',
  ...
  },
  {
    ...
    usage:
      'manta orchestration task-create --spec <text> [--task-title <text>] [--display-name <text>] [--deps <json_array>] [--parent <task_id>] [--run <run_id>] [--from <handle>] [--retry-request <id>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'spec',
      'task-title',
  ...
  },
  {
    ...
    usage:
      'manta orchestration task-list [--status <status>] [--ready] [--brief] [--run <run_id>] [--from <handle>] [--json]',
  ...
  },
  {
    ...
    usage:
      'manta orchestration task-update --id <task_id> --status <status> [--result <json>] [--run <run_id>] [--from <handle>] [--retry-request <id>] [--json]',
  ...
  ...ORCHESTRATION_WORKER_COMMAND_SPECS,
  {
    ...
    usage:
      'manta orchestration dispatch --task <task_id> --to <handle> [--from <handle>] [--run <run_id>] [--inject] [--dry-run] [--return-preamble] [--retry-request <id>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'task',
      'to',
  ...
  },
  {
    ...
    notes: [
      ...
      'completed means the mutation landed and --retry-request replays the recorded outcome instead of starting a second one. pending means the original mutation is still running or Manta restarted before recording its outcome; wait for a live original command, otherwise replay with --retry-request.',
  ...
  },
  {
    ...
    usage:
      'manta orchestration dispatch-show --task <task_id> [--preamble] [--from <handle>] [--json]',
  ...
  },
  {
    ...
    usage:
      'manta orchestration ask (--question <text> | --resume <message_id>) [--to <run:id>] [--run <run_id>] [--options <csv>] [--timeout-ms <n>] [--from <handle>] [--retry-request <id>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'to',
      'run',
  ...
  },
  {
    ...
    usage:
      'manta orchestration coordinator-start --spec <text> [--from <handle>] [--poll-interval-ms <n>] [--max-concurrent <n>] [--worktree <selector>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'spec',
      'from',
  ...
  },
  {
    ...
    summary: 'Retired: load the current orchestration skill',
    usage: 'manta orchestration coordinator-stop [--json]',
  ...
  },
  {
    ...
    usage:
      'manta orchestration gate-create --task <task_id> --question <text> [--options <json_array>] [--from <handle>] [--retry-request <id>] [--json]',
  ...
  },
  {
    ...
    usage:
      'manta orchestration gate-resolve --id <gate_id> --resolution <text> [--from <handle>] [--retry-request <id>] [--json]',
  ...
  },
  {
    ...
    usage:
      'manta orchestration gate-list [--task <task_id>] [--status <status>] [--run <run_id>] [--from <handle>] [--json]',
  ...
  },
  {
    ...
    usage:
      'manta orchestration reset (--all | --tasks | --messages) [--retry-request <id>] [--json]',
