...
export const BROWSER_BASIC_COMMAND_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    usage: 'manta goto --url <url> [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'url', 'worktree']
  },
  {
    path: ['back'],
    summary: 'Navigate back in browser history',
    usage: 'manta back [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'worktree']
  },
  {
    path: ['reload'],
    summary: 'Reload the active browser tab',
    usage: 'manta reload [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'worktree']
  },
  {
    path: ['eval'],
    summary: 'Evaluate JavaScript in the browser page context',
    usage: 'manta eval --expression <js> [--worktree <selector>] [--json]',
  ...
  },
  {
    ...
    usage:
      'manta wait [--selector <sel>] [--timeout <ms>] [--text <text>] [--url <pattern>] [--load <state>] [--fn <js>] [--state <hidden|visible>] [--worktree <selector>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'selector',
      'timeout',
  ...
  },
  {
    ...
    usage: 'manta tab create [--url <url>] [--worktree <selector>] [--profile <id>] [--json]',
  ...
  },
  {
    ...
    usage: 'manta tab profile list [--json]',
    allowedFlags: [...GLOBAL_FLAGS]
  },
  {
    path: ['tab', 'profile', 'create'],
    summary: 'Create a browser session profile for browser tabs',
    usage: 'manta tab profile create --label <name> [--scope <isolated|imported>] [--json]',
