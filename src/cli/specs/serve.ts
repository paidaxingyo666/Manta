...
export const SERVE_COMMAND_SPECS: CommandSpec[] = [
  {
    path: ['serve'],
    summary: 'Start a Manta runtime server without opening a desktop window',
    usage:
    ...
    examples: [
      'manta serve',
      'manta serve --json',
      'manta serve --project-root /workspace/repo --pairing-address wss://sandbox.example.com --recipe-json',
