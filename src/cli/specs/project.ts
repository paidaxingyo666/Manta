...
export const PROJECT_COMMAND_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    examples: [
      ...
      'manta project setup-existing-folder --project github:stablyai/manta --host runtime:gpu --path /home/me/manta --kind git --json'
    ]
  },
  {
    ...
    examples: [
      ...
      'manta project setup-clone --project github:stablyai/manta --host runtime:gpu --url https://github.com/stablyai/manta.git --destination /srv --json'
    ]
  },
  {
    ...
    examples: [
      'manta project setup-create --project github:stablyai/manta --host runtime:gpu --state setting-up --method provisioned --json'
    ]
  },
  {
