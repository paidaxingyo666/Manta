...
export const ORCHESTRATION_WORKER_COMMAND_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    usage:
      'manta orchestration worker-list [--run <run_id>] [--terminal-state <active|reclaimable|retained|release_pending|release_unknown|released>] [--json]',
