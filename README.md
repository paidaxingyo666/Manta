...
[iOS App Store](https://apps.apple.com/us/app/manta-ide/id6766130217) · [TestFlight](https://testflight.apple.com/join/YjeGMQBA) · [Android APK 0.0.48](https://github.com/stablyai/orca/releases/download/mobile-android-v0.0.48/app-release.apk) · [Docs →](https://www.manta.sh.cn/docs/mobile)
...
- **Android:** [Download APK 0.0.48](https://github.com/stablyai/orca/releases/download/mobile-android-v0.0.48/app-release.apk) · [Install guide](https://www.manta.sh.cn/docs/android-apk)
...
- **WeChat:** Scan to join the Manta community WeChat group 8. Group 8 may be full; if so, scan the Group 9 QR code instead.

  <img src="docs/assets/wechat-qr-group8.jpg" alt="WeChat group 8 QR code for the Manta community" width="160" />&nbsp;&nbsp;<img src="docs/assets/wechat-qr-group9.jpg" alt="WeChat group 9 QR code for the Manta community" width="160" />
