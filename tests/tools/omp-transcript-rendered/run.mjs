...
if (process.env.MANTA_BACKGROUND_LAUNCH !== '1' || !process.argv[2]) {
  throw new Error('Requires MANTA_BACKGROUND_LAUNCH=1 and the runtime smoke JSON path')
}
...
const report = {
  scope:
    'Production desktop message list renders actual OMP SessionManager transcripts read through Manta; hidden Electron fixture, no full shell or model turn.',
  results: []
}
try {
