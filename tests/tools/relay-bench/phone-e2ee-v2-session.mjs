...
const TRANSCRIPT_DOMAIN = 'manta-mobile-e2ee/v2/transcript'
const SALT_LABEL = utf8('manta-mobile-e2ee/v2/salt\0')
const INFO_LABEL = utf8('manta-mobile-e2ee/v2/session\0')
