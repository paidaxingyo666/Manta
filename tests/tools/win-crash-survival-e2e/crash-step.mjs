...
//
// GitHub #7742: when Manta's main/renderer process died on Windows, the terminal
 ...
 * or image-named process, so a live user Manta on the same box is never touched.
 */
