...
export const GOLDEN_GIT_AUTHOR_NAME = 'Manta E2E'
export const GOLDEN_GIT_AUTHOR_EMAIL = 'manta-e2e@example.invalid'
...
export function installPassingNodePreCommitHook(fixture: GoldenWorktree): string {
  const hooksPath = mkdtempSync(path.join(os.tmpdir(), 'manta-e2e-git-hooks-'))
