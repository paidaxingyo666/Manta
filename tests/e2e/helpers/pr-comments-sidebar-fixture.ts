...
export const FIXTURE_COMMENTS: PRComment[] = [
  {
    ...
    url: 'https://github.com/acme/manta/pull/73#discussion_r101',
  ...
  },
  {
    ...
    url: 'https://github.com/acme/manta/pull/73#issuecomment-102',
  ...
  },
  {
    ...
    url: 'https://github.com/acme/manta/pull/73#discussion_r103',
...
export async function seedPRCommentsSidebarFixture(page: Page): Promise<PRCommentsSidebarSeed> {
  return page.evaluate(async (fixtureComments: PRComment[]) => {
    ...
    const pr: PRInfo = {
      ...
      state: 'open',
      url: `https://github.com/acme/manta/pull/${prNumber}`,
      checksStatus: 'pending',
      updatedAt: '2026-05-15T00:00:00.000Z',
      mergeable: 'MERGEABLE',
      prRepo: { owner: 'acme', repo: 'manta' }
    }
    ...
    window.localStorage.setItem('manta:pr-comment-presentation', 'cards')
