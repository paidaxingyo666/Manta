...
const RUN_REAL_REMOTE_CODEX = process.env.MANTA_E2E_REAL_REMOTE_CODEX === '1'
const EXPECT_NO_ARTIFACTS = process.env.MANTA_E2E_EXPECT_NO_CODEX_ARTIFACTS === '1'
const CAPTURE_WHILE_REMOTE_TUI_RUNNING =
  process.env.MANTA_E2E_CAPTURE_WHILE_REMOTE_TUI_RUNNING === '1'
