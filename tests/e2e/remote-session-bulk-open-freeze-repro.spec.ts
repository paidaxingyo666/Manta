 ...
 *
 * Topology under test:
 *   R1: headless Remote Manta host + paired desktop web client (paired-remote-server)
 *
 * Measurement:
...
const USE_DESKTOP_PAIR = process.env.MANTA_E2E_FREEZE_DESKTOP_PAIR === '1'
