...
const scratch = mkdtempSync(path.join(os.tmpdir(), 'manta-paired-materialize-'))
...
// Why fixme: this journey's fault injection cannot be set up on a headless `manta serve` host.
